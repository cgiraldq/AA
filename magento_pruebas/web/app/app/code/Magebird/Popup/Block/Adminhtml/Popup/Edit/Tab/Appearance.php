    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $note = '<p class="nm"><small>' . "Default is 6" . '</small></p>';        
        ...
        $note = '<p class="nm"><small>' . __('Write 0 if no border') . '</small></p>';
        ...
        $note = '<p class="nm"><small>'.__('Enter #FFFFFF for white. Leave empty for no background. Use Hex value. You can use <a target="_blank" href="http://www.colorpicker.com/">Colorpicker.com</a> to pick color.').'</small></p>';
        ...
        $note = '<p class="nm"><small>'.__('Space between popup border/corners and content. Recommended is 10px.').'</small></p>';
        ...
        $note = "<p class='nm'><small>". __('Write selector + rule (e.g. <span style="font-style:italic;">.dialogBody{font-size:20px}</span>). Leave blank if you don\'t know what is that.')."</small></p>";
        ...
        $note = "<p class='nm'><small>". __('Here you can write custom javascript code for your popup. Leave blank if you don\'t know what is that.')."</small></p>";
