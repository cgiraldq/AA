...
class EmailServices extends \Magento\Backend\Block\Template
{
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
      ...
      $msg = '';      
      if($services){
        $msg = __("To insert also ".implode($services,", ")." list id, enable it first inside Store->Configuration->MAGEBIRD EXTENSIONS->Popup->Email services. After you enabled it new options will show up here.");
      }
