...
$nombrecampos="Id,Nombre,Login,Activo";
	...
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <td align="center">
		  <input type="text" name="dslogin_[]" value="<? echo $result->fields[2]?>" size="30" class="textnegro" maxlength="100">
			</td>
		  ...
		  <?
		  $rutax="usuarios.editar.php?idx=".$result->fields[0];
