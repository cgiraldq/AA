		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <td align="center">
			...
			<option value="1" <? if ($result->fields[5]==1) echo "selected";?>>REGISTRO</option>
		    <option value="3" <? if ($result->fields[5]==3) echo "selected";?>>CONTACTO</option>
		  ...
		  |
		  <a class="textlink2" href="" onClick="irAPaginaDN('../../../modulos/validaciones/cuerpo.correo.php?idx=<? echo $result->fields[0]?>&idactivo=<?echo $result->fields[5]?>')">Vista Previa</a>
		  |
		  <?
