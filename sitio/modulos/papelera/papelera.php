...
$dsm="dsm";
if($tabla=="tblvotacionfechainscripcion")$dsm="dsfechainicial";
if($tabla=="tblvotacionfechavotacion")$dsm="dsfechainicial";
if($tabla=="tblvotacionfechaescrutinios")$dsm="dsfechainicial";
if($tabla=="tblvotacionmensajesasociados")$dsm="dsmensaje";
if($tabla=="tblcandidatos")$dsm="dsasociado";
...
if($tabla<>"tbltipovotacion"){
$rutamodulo.="<a href='$rutxx../votaciones/tipovotacion/default.php' class='textlink' title=' Administrador de votaciones '> Administrador de votaciones </a>  /  ";
}
$rutamodulo.="<a href='$dsrutap?idtv=$idtv' class='textlink' title='Principal $titulomodulo2 '>$titulomodulo2</a>  /  ";
