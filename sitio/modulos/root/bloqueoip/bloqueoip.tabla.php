...
$nombrecampos="Id,Direccion IP,Autorizado,Activo";
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <input type="text" name="id_[]" value="<? echo $result->fields[0]?>" size="2" readonly class="textnegro">
			  ...
			  <td align="center">
		  <input type="text" name="dsm_[]" value="<? echo $dsclave = $rc4->decrypt($s3m1ll4, urldecode($result->fields[1]));?>" size="30" class="textnegro" maxlength="100">
			</td>
			<td align="center">
		  <input type="text" name="dsautorizado_[]" value="<? echo $result->fields[3];?>" size="30" class="textnegro" maxlength="100">
			</td>
