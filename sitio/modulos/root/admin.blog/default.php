		...
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			if ($db->Execute($sql))  {
				...
				$dsruta="../administrador/admin.blog/default.php";
...
$sql="select a.id,a.dsm,a.idactivo from $tabla a where id>0 and idactivo<>9";
...
$result=$db->PageExecute($sql,$maxregistros,$pagina_actual);
	if (!$result->EOF) {
		...
		include("blog.tabla.php");
		include($rutxx."../../incluidos_modulos/paginar.php");
	} // fin si
$result->Close();
	//include("blog.ingreso.php");
