...
<tr>
	<td>
		<input type="checkbox" name="Adjuntar" value="1" onclick="ActivarTodoGeneral2('u','Adjuntar','sel[]')" />
...
<?
	...
	?>
	 <tr >
	<?
		include($rutxx."../relaciones/relaciones.datos.agrupamiento.php");//2
		$resultx->MoveNext();
		 if (!$resultx->EOF) {
			include($rutxx."../relaciones/relaciones.datos.agrupamiento.php");//2
			$resultx->MoveNext();
