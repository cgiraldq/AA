...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="campos_relacion">
<?
	while (!$resultx->EOF) {
	?>
	 <tr >
	<?
		include($rutxx."../relaciones/relaciones.datos.vista.php");//2
		$resultx->MoveNext();
		 if (!$resultx->EOF) {
			include($rutxx."../relaciones/relaciones.datos.vista.php");//2
			$resultx->MoveNext();
