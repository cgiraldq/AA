...
if ($tablaorigen=="tblproductos") $sql.=",dsreferencia ";
...
<tr><td><input type="checkbox" name="Adjuntar" value="1" onclick="ActivarTodoGeneral('u','Adjuntar','sel[]')" /><strong>Seleccionar todo</strong></td></tr>
</table>
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="text1">
<?
	while (!$resultx->EOF) {
	?>
	 <tr >
	<?		
			include($rutxx."../relaciones/relaciones.datos.precios.php");//2
			$resultx->MoveNext();
		 if (!$resultx->EOF) {
