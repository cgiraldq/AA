...
if($posicion==1)$mostrarpos=",idpos";
 $sql="select iddestino$mostrarpos from $tablarelaciones where idorigen='$idx' and iddestino='$id';";
 //echo $sql;
...
<input type="checkbox" name="select_<? echo $id?>" value="<? echo $id?>" <? if ($id==$idbasedestino) echo "checked";?>>&nbsp;<? echo $dsm?> <? echo $txt?>
<input type="hidden" name="sel[]" value="<? echo $id?>">
</td>
