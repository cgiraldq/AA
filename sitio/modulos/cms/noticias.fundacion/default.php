...
$titulomodulo="Configuraci&oacute;n de novedades";
$dsm=$_REQUEST['dsm'];
$idpos=$_REQUEST['idpos'];
$idactivo=$_REQUEST['idactivo'];

$letra=$_REQUEST['letra'];
$tabla="tblnoticiasfundacion";
...
$sql="select a.id,a.dsm,a.idpos,a.dsimg,a.dsrutaPapelera,a.idactivo,a.idtipo from $tabla a where id>0 and idactivo<>9";
...
$result=$db->PageExecute($sql,$maxregistros,$pagina_actual);
	if (!$result->EOF) {
		...
		include("noticias.tabla.php");
		include($rutxx."../../incluidos_modulos/paginar.php");
	} // fin si
$result->Close();
	include("noticias.ingreso.php");
