...
$titulomodulo="Configuracion de convenios";
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="tblconvenios";
...
//$include="include('../../beta/qsomos.php')";
			...
			$dsbeneficios=$_REQUEST['dsbeneficios'];
			...
			//exit;
					if ($db->Execute($sql))  {
						...
						include("../../relaciones/relaciones.operaciones.convenios.php");
						$error=0;
...
$sql="select a.dsm,a.dsd,a.dsimg,a.idpos,a.dsruta,a.idactivo,dsvideo,dstitulo,dsciudad,dstelefono,dsdireccion,dsdescuento";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
...
$dsciudad=$result->fields[8];
$dstelefono=$result->fields[9];
$dsdireccion=$result->fields[10];

$dsbeneficios=$result->fields[11];
...
<tr valign=top bgcolor="#FFFFFF">
<td>Ciudades del convenio</td>
<td>
<? $contadorx="dsciudad_counter";$valorx="255";$formax="u";$campox="dsciudad";?>
<input type=text name=dsciudad size=45 maxlength="255" class=text1 onKeyPress="ocultar('capa_dsciudad')"
value="<? echo $dsciudad?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
<?
$nombre_capa="capa_dsciudad";
$mensaje_capa="Debe ingresar la ciudad del convenio";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");?>
</td>
</tr>
...
<td>Telefonos</td>
<td>
<? $contadorx="dstelefono_counter";$valorx="255";$formax="u";$campox="dstelefono";?>
<input type=text name=dstelefono size=45 maxlength="255" class=text1 onKeyPress="ocultar('capa_dstelefono')"
value="<? echo $dstelefono?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
<?
$nombre_capa="capa_dstelefono";
$mensaje_capa="Debe ingresar la telefono del convenio";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");?>
</td>
</tr>
...
<td>
<? $contadorx="dsdireccion_counter";$valorx="255";$formax="u";$campox="dsdireccion";?>
<input type=text name=dsdireccion size=45 maxlength="255" class=text1 onKeyPress="ocultar('capa_dsdireccion')"
value="<? echo $dsdireccion?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
<?
$nombre_capa="capa_dsdireccion";
$mensaje_capa="Debe ingresar la direccion del convenio";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");?>
</td>
</tr>
...
<td>Beneficios</td>
<td>
<? $contadorx="dsbeneficios_counter";$valorx="12000";$campox="dsbeneficios";?>
<textarea name=dsbeneficios cols=80  rows="8" class=text1 onKeyPress="ocultar('capa_dsbeneficios')"
<? include($rutxx."../../incluidos_modulos/control.evento.php");?>><? echo $dsbeneficios?></textarea>
<?
$nombre_capa="capa_dsbeneficios";
$mensaje_capa="Debe ingresar la Beneficios";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");?>
</td>
</tr>
...
<td>
	<select name=idactivo class=text1>
		  <!--option value="1" <? if ($idactivo==1) echo "selected";?>>PRINCIPAL</option-->
...
<?include($rutxx."../relaciones/default.convenios.php");?>
