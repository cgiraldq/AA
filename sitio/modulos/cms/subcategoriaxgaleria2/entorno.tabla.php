...
$contar=0;
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		<td align=center>
		  ...
		  <?
		  $rutax="entorno.editar.php?idx=".$result->fields[0]."&idy=".$result->fields[6]."&idg=".$idg;
		  include($rutxx."../../incluidos_modulos/enlace.detalles.php");
		  ?>
		  |
		  <?
		  $rutax=$pagina."?idx=".$result->fields[0]."&idy=".$_REQUEST['idy']."&idg=".$idg;
		  $formax="";
...
<input type="hidden" name="idg" value="<? echo $idg;?>">
</td></tr>
</form>
