...
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="tblpaisesmovil";

$tablarelaciones="tblpaisxdepartamento";
$tablaorigen="tbldepartamentos";
...
$sql="select a.id,a.dsm,a.idactivo,a.idpos,a.dsimg1,a.dsd";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
//echo $sql;
...
<tr valign=top >
	<td colspan="2">
		<p style="text-align: left;"><strong>RELACIONES.</strong> Asocie ciudades al pais</p>
	<br>
