...
$titulomodulo="Configuraci&oacute;n de Indicadores";
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="tblindicadores";
$rutaImagen=$rutxx."../../../contenidos/images/redes/";
			...
			//exit;
					...
					if ($db->Execute($sql))  {
						...
						$dsruta="../cms/indicadores/default.php";
...
$sql="select a.dsm,a.dsruta,a.dsimg1,a.idpos,a.idactivo,a.idtienda,a.dsimg2,a.idestado";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
//echo $sql;
...
<tr valign=top bgcolor="#FFFFFF">
<td>Indicador bajo? o Subio?</td>
<td>
	<select name="idestado" class=text1>
		  <option value="1" <? if ($idestado==1) echo "selected";?>>SUBIO</option>
		  <option value="2" <? if ($idestado==2) echo "selected";?>>BAJO</option>
	</select>

</td>
</tr>
<!--tr valign=top bgcolor="#FFFFFF">
<td>Imagen 1 encabezado </td>
