...
$contar=0;
	while (!$result->EOF && ($contar<$maxregistros)) {
	  ...
	  <select name="idactivo_[]" class="textnegro">
		  ...
		  <option value="3" <? if ($result->fields[3]==3) echo "selected";?>>Solo imagen</option>
	  </select>
		</td>
		  ...
		  <?
		  $rutax="destacado.editar.php?idx=".$result->fields[0];
...
?>
<tr><td colspan=<? echo $total?> align="center" style="padding: 10px 0;">
