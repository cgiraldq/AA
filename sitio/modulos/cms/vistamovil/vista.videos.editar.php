...
$titulomodulo="Configuracion de videos vista m&oacute;vil";
$rr="vista.videos.php";
$idx=$_REQUEST['idx'];
$tabla="tblvistavideos";

$tablarelaciones="tblvistaxtblvideos";
...
$rutamodulo.="<a href='$rutxx../cms/vistamovil/default.php' class='textlink' title='Principal'>Vista m&oacute;vil</a> /  <a href='vista.banner.php' class='textlink'>Configuraci&oacute;n de videos vista móvil</a>  /  <span class='text1'>Modificar</span>";
...
<!--tr valign=top >
	<td class="txt"><p>Digite la ruta a la cual se envia cuando se da click.</p></td>
...
<tr valign=top >
	<td class="txt"><p>Al dar click sobre el banner montado, se abre. </p></td>
	<td>
...
<!--tr valign=top >
	<td class="txt"><p>Subir imagen del banner.</p></td>
...
<tr valign=top >
	...
	<td>
		<select name=idactivo class=text1>
		    <option value="1" <? if ($idactivo==1) echo "selected";?>>DESTACADO</option>
		    <option value="2" <? if ($idactivo==2) echo "selected";?>>NO</option>
		    <option value="3" <? if ($idactivo==3) echo "selected";?>>SUPERIOR</option>
		    <option value="4" <? if ($idactivo==4) echo "selected";?>>INFERIOR</option>
...
<tr valign=top >
	<td colspan="2">
		<p style="text-align: left;"><strong>RELACIONES.</strong> Asociar en que p&aacute;ginas desea ver este Banner</p>
	<br>
	<?
	$validar=" where idvista='1' ";
