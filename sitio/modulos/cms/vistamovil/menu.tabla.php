...
$nombrecampos="Id,Ruta,Posici&oacute;n,Activo";
	...
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <td align="center">
		  <input type="text" name="idpos_[]" value="<? echo $result->fields[2]?>" size="5" class="textnegro" maxlength="2">
			</td>
