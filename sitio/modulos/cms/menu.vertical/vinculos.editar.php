...
$titulomodulo="Configuraci&oacute;n de men&uacute; vertical";
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="tblmenu_vertical";
$rutaImagen=$rutxx."../../../contenidos/images/redes/";
			...
			//exit;
					...
					if ($db->Execute($sql))  {
						...
						$dsruta="../cms/vinculos/default.php";
...
$sql="select a.dsm,a.dsruta,a.dsimg1,a.idpos,a.idactivo,a.idtienda,a.dsimg2,dsmodo";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
//echo $sql;
...
<tr valign=top bgcolor="#FFFFFF">
	<td>Al dar click sobre el men&uacute;,<br> se abre:</td>
	<td>
