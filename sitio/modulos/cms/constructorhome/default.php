...
$titulomodulo="Configuracion del constructor del home";
$dsm=$_REQUEST['dsm'];
		...
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			if ($db->Execute($sql))  { 
				...
				$dsruta="../cms/constructorhome/default.php";
...
$sql="select a.id,a.dsm,a.idpos,a.idactivo,dsimg from $tabla a where id>0 and idactivo<>9";
...
if ($orderby<>"") { 
	...
	$rutamodulo="<a href='../../core/default.php' class='textlink' title='Principal'>Principal</a>  /  ";
		...
		$dsrutap="../cms/constructorhome/default.php";
		include($rutxx."../../incluidos_modulos/modulos.subencabezado.php");
$result=$db->PageExecute($sql,$maxregistros,$pagina_actual);
	if (!$result->EOF) {
		
		include("constructorhome.tabla.php");
		include($rutxx."../../incluidos_modulos/paginar.php");
	} // fin si 
$result->Close();
	include("constructorhome.ingreso.php");
