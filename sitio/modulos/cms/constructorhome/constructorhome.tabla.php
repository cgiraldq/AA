...
?>
<br>
<div align=center><a href="../../../index.php?edit=1" target="_blank" class="botones">VER POSICIONES HOME PARA EDITAR</a></dv>
<br>
...
$nombrecampos="Id,Imagen,Nombre,Posici&oacute;n,Activo";
		 ...
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
			  ...
			  <td align=center>
				<?$dsimg1=$result->fields[4];
				 ...
				 <a class="customlightbox" title="Click para ver la imagen" href="<? echo $rutaImagen.$dsimg1;?>" rel="group2">
		      		<img src="<? echo $rutaImagen.$dsimg1;?>" width="100" heigth="100">
            	</a>
		  ...
		  <td align="center">
			  <select name="idactivo_[]" class="textnegro">
				  <option value="1" <? if ($result->fields[3]==1) echo "selected";?>>Imagen</option>
				  <option value="2" <? if ($result->fields[3]==2) echo "selected";?>>NO</option>
				  <option value="3" <? if ($result->fields[3]==3) echo "selected";?>>Contenido</option>
				  <option value="4" <? if ($result->fields[3]==4) echo "selected";?>>DestacadoIndex</option>
				  <option value="5" <? if ($result->fields[3]==5) echo "selected";?>>Video</option>
			  </select>
		  </td>
		  ...
		  <td align="center">
		  <?
		  $rutax="constructorhome.editar.php?idx=".$result->fields[0];
