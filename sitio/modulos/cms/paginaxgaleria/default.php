...
$titulomodulo="Configuraci&oacute;n imagen X Galeria";
$dsm=$_REQUEST['dsm'];
...
//echo $sql;
	...
	$rutamodulo="<a href='$rutxx../cms/paginagaleria/default.php' class='textlink' title='Principal'>Configuracion Galeria de imagenes</a>  /  ";
