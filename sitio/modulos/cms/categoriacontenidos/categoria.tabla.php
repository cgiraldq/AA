...
$nombrecampos="Id,Imagen,Nombre,Posici&oacute;n";
$nombrecampos.=",Activo";
	...
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <td align="center">
		   <?
		  $rutax="categoria.editar.php?idpo=$idpo&idx=".$result->fields[0];
		  include($rutxx."../../incluidos_modulos/enlace.detalles.php");?>
		  |

		  <?
		  $rutax=$pagina."?idtipo=$idtipo&idx=".$result->fields[0]."&idpo=$idpo";
		  $formax="";
		  include($rutxx."../../incluidos_modulos/enlace.eliminar.php");?>
		  </td>
		  <input type="hidden" name="idpo" value="<? echo $result->fields[5];?>">
			</tr>
