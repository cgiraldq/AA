		...
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			$mensajes=$men[0];
		 	...
		 	// insertar
			$sql="insert into $tabla (dsm,idpos,idactivo,idcat)";
			$sql.=" values ('$dsm',$idpos,$idactivo,$idpo) ";
			if ($db->Execute($sql))  {
...
$sql="select a.id,a.dsm,a.idpos,a.idactivo,a.dsimg1,a.idcat from $tabla a where id>0 and idactivo<>9 ";
if ($letra<>"") $sql.=" and a.".$_REQUEST['campoletra']." like '$letra%'";
if ($_REQUEST['param']<>"") $sql.=" and a.".$_REQUEST['campo']." like '".$_REQUEST['param']."%'";
if ($_REQUEST['idpo']<>"") $sql.=" and a.idcat='".$_REQUEST['idpo']."'";
if ($orderby<>"") {
...
//echo $sql;
	...
	$rutamodulo="<a href='../contenidoinferior/default.php' class='textlink' title='Principal'>Administraci&oacute;n de Contenidos Inferiores</a>  / contenidos ";
