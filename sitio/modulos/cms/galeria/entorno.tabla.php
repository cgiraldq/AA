...
<table width="100%" border="0" cellpadding="2" cellspacing="1" align="center" class="tbl_lista">
		 ...
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <td align="center">
			  <select name="idactivo_[]" class="textnegro">
				  <?if($idevento<>""){?>
				  <option value="4" <? if ($result->fields[3]==4) echo "selected";?>>SI</option>
				  <option value="2" <? if ($result->fields[3]==2) echo "selected";?>>NO</option>
				  <?}?>
				  <?if($idevento==""){?>
				  <option value="1" <? if ($result->fields[3]==1) echo "selected";?>>SI</option>
				  <option value="3" <? if ($result->fields[3]==2) echo "selected";?>>tiendas</option>
				  <option value="2" <? if ($result->fields[3]==2) echo "selected";?>>NO</option>
				  <?}?>
		  ...
		  <td align="center">
		  <?
		  $rutax="entorno.editar.php?idx=".$result->fields[0]."&idevento=".$idevento;
