...
$titulomodulo="Configuracion de Qui&eacute;nes Somos";
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="tblqsomos";
...
<tr valign=top bgcolor="#FFFFFF">
<td>T&iacute;tulo en el men&uacute;</td>
<td>
...
<tr valign=top bgcolor="#FFFFFF">
<td>C&oacute;digo video Youtube</td>
<td>
	...
	<select name=idactivo class=text1>
		  ...
		  <option value="2" <? if ($idactivo==2) echo "selected";?>>NO</option>
		   ...
		   <option value="4" <? if ($idactivo==4) echo "selected";?>>MEN&uacute; VERTICAL</option>
		    <option value="5" <? if ($idactivo==5) echo "selected";?>>CARRUSEL</option>
	</select>
