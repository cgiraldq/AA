	...
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		<td align="center">
		  ...
		  <select name="idactivo_[]" class="textnegro">
			...
			<option value="3" <? if ($result->fields[3]==3) echo "selected";?>>LATERAL TOP</option>

		    <!--option value="4" <? if ($result->fields[3]==4) echo "selected";?>>LATERAL MEDIA</option-->
    		<option value="5" <? if ($result->fields[3]==5) echo "selected";?>>BANNER INFERIOR</option>
			 <option value="6" <? if ($result->fields[3]==6) echo "selected";?>>DEBAJO DEL MENU</option>
			 <option value="7" <? if ($result->fields[3]==7) echo "selected";?>>PAGINAS INTERNAS</option>
		  ...
		  <?
		  $rutax="banners.editar.php?idx=".$result->fields[0];
