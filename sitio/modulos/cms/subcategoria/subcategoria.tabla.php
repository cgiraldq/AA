...
$nombrecampos="Id,Nombre,Posici&oacute;n,Activo,Categoria";
	...
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <option value="2" <? if ($result->fields[3]==2) echo "selected";?>>NO</option>
				...
				<td align="center">
					<select name="idcategoria_[]" class="textnegro">
						<? listar_categorias("tblcategoria",$result->fields[4]); ?>
					</select>
				</td>
		  ...
		  <td align="center">
		   <?
		  $rutax="subcategoria.editar.php?idx=".$result->fields[0];
