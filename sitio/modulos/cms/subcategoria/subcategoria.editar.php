...
$rutaImagen=$rutxx."../../../contenidos/images/producto/";
			...
			//exit;
					...
					if ($db->Execute($sql))  {
						...
						$dsruta="../cms/subcategoria/default.php";
...
$sql="select a.dsm,a.idpos,a.idactivo,a.idcategoria,a.dsimg1";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
...
<td>
			<select name="idcategoria" class="text1">
			  <? listar_categorias("tblcategoria",$result->fields[3]); ?>
		  	</select>
</td>
</tr>
