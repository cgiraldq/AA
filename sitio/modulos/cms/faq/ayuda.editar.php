...
$idx=$_REQUEST['idx'];
$tabla="tblfaqs";
$tablarelaciones="tblfaqsxtblpaginas";
$tablaorigen="tblpaginas";

$rutaImagen="../../../../contenidos/images/ayuda/";
// rutas repro
...
<td>
	<select name=idactivo class=text1>
		  ...
		  <option value="3" <? if ($idactivo==3) echo "selected";?>>DESTACADA LATERAL</option>
	</select>
...
<tr valign=top bgcolor="#FFFFFF">
<td colspan="2">
<strong>RELACIONES.</strong> Asocie en que pagina desea ver este item
<br>
