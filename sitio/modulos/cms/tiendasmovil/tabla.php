...
$nombrecampos="Id,Titulo,Posici&oacute;n,Ciudad,Activo";
...
$contar=0;
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		<td align="center">
		<select name="idciudad_[]" id="idciudad_[]">
		<option value="">--Seleccion--</option>
		<?categorias('tblciudades',$result->fields[6])?>
		  ...
		  <td align="center">
			  <select name="idactivo_[]" class="textnegro">
				  <option value="1" <? if ($result->fields[5]==1) echo "selected";?>>DISTRIBUIDORES</option>
				  <option value="2" <? if ($result->fields[5]==2) echo "selected";?>>NO</option>
				  <option value="3" <? if ($result->fields[5]==3) echo "selected";?>>Tiendas</option>	  
			  </select>
		  </td>
