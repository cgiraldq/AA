...
$titulomodulo="Configuraci&oacute;n del boletin";
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="tblboletin";
$rutaImagen=$rutxx."../../../contenidos/images/asociados/";
// rutas repro
//$rutaRepro=$rutaAbs."/contenidos/images/asociados/";
//$rutaPlayer="../"; // uso desde el admon
//$carpeta="asociados";
//echo $carpetaBase;
//$include="include('../../beta/asociados.php')";
...
<tr valign=top bgcolor="#FFFFFF">
	...
	<td>
	<? $contadorx="dstitulo_counter";$valorx="10";$formax="u";$campox="dstitulo";$cantidad=strlen($dstitulo)?>
	<input type=text name=dstitulo size=10 maxlength="10" class=text1 onKeyPress="ocultar('capa_dstitulo')" readonly  value="<? echo $dstitulo?>"
	 <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
	<img align="absmiddle" SRC="<? echo $rutxx;?>../../img_modulos/modulos/calendario.gif" ALT="Calendario" name="imgFecha" ID="imgFecha" STYLE="cursor:hand;position:relative" BORDER="0" onClick="displayDatePicker('dstitulo', this);" language="javaScript">
	<?
