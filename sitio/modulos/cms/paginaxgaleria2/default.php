...
if ($dsm<>"" && $idpos<>"") {
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			$sql="insert into $tabla (dsm,idpos,idactivo,idgaleria,dsruta)";
			$sql.=" values ('$dsm',$idpos,$idactivo,'$idy','$dsrutax')";
			//echo $sql;
			if ($db->Execute($sql))  {
...
//echo $sql;
	...
	$rutamodulo="<a href='$rutxx../cms/galeria2/default.php' class='textlink' title='Principal'>Configuracion categorías de Galeria</a>  /  ";
		$rutamodulo.=" <span class='text1'>".$titulomodulo."</span> / ".$dsm;
