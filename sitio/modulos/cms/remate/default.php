...
$titulomodulo="Configuraci&oacute;n de Remate";
$dsm=$_REQUEST['dsm'];
...
$sql="select a.id,a.dsm,a.dsimg1,a.idpos,a.idactivo from $tabla a where id>0 and idactivo<>9";
...
$result=$db->PageExecute($sql,$maxregistros,$pagina_actual);
	if (!$result->EOF) {
		...
		include("remate.tabla.php");
		include($rutxx."../../incluidos_modulos/paginar.php");
	} // fin si
$result->Close();

	//include("remate.ingreso.php");
