...
$idx=$_REQUEST['idx'];
$tabla="tblcarrousel";
$rutaImagen=$rutxx."../../../contenidos/images/carrousel/";
// rutas repro
...
//$include="include('../../beta/qsomos.php')";
			...
			//exit;
					...
					if ($db->Execute($sql))  {
						...
						$dsruta="../cms/carrousel/default.php";
...
$sql="select a.dsm,a.dsd,a.dsimg,a.idpos,a.dsruta,a.idactivo,dsimg2,dsruta";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
...
$mensaje_capa="Debe ingresar ruta del enlace";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");?>
</td>
</tr>
