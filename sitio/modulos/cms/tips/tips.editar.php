...
$idx=$_REQUEST['idx'];
$tabla="tbltips2";
$rutaImagen=$rutxx."../../../contenidos/images/tips/";
// rutas repro
//$rutaRepro=$rutaAbs."/contenidos/images/qsomos/";
//$rutaPlayer="../"; // uso desde el admon
$carpeta="tips";
//echo $carpetaBase;
$include="include('../../tienda/tips_detalle.php')";
...
$sql="select a.dsm,a.dsd,a.dsd2,a.dsimg,a.idpos,a.dsruta,a.idactivo,a.dsimg2,a.dsvideo,a.dsvideo2,a.dssub";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
...
<td>
<? $contadorx="dssub_counter";$valorx="255";$formax="u";$campox="dssub";?>
<input type=text name=dssub size=45 maxlength="255" class=text1 onKeyPress="ocultar('capa_dssub')" value="<? echo $dssub?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
<?
$nombre_capa="capa_dssub";
$mensaje_capa="Debe ingresar el Subtitulo";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");?>
</td>
</tr>
