...
$nombrecampos="Id,T&iacute;tulo,Posici&oacute;n,Activo";
		 ...
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <td align="center">
			  <select name="idactivo_[]" class="textnegro">
				...
				<option value="3" <? if ($result->fields[5]==3) echo "selected";?>>DESTACADO</option>
				<option value="4" <? if ($result->fields[5]==4) echo "selected";?>>LATERAL</option>
				<option value="5" <? if ($result->fields[5]==5) echo "selected";?>>ZONA PRIVADA</option>
		  ...
		  |
		  <?
		  $rutax="tips.editar.php?idx=".$result->fields[0];
		  include($rutxx."../../incluidos_modulos/enlace.detalles.php");?>
		  |

		   <?
		  $rutax="../../cms/galeriatips/default.php?idevento=".$result->fields[0];
