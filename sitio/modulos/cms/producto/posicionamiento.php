...
$titulomodulo="Posicionamiento de servicios";
$idpo=$_REQUEST['idpo'];
$idtipoprod=$_REQUEST['idtipoprod'];
if ($idtipoprod=="2") $titulomodulo="Posicionamiento de Servicios";
$rr="default.producto.php?idtipoprod=$idtipoprod";


$tabla=$prefix."tblproductos";
			...
			if ($paso=="1") {
				...
				//echo $sql;
					...
					if ($db->Execute($sql))  {
						...
						$dsruta="../cms/productos/default.php?idtipoprod=$idtipoprod";
...
$rutamodulo="<a href='$rutxx../core/default.php' class='textlink'>Principal</a>  / <a href='default.producto.php' class='textlink'>$titulomodulo</a>  /  <span class='text1'>Posicionamiento</span>";
...
<input type=text name=dsm size=45 maxlength="255" readonly class=text1 onKeyPress="ocultar('capa_dsm')" value="<? echo $dsm?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
<?
