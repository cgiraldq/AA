...
$tablarelaciones=$prefix."ecommerce_tblpromocionesxsubcategoria";
$tablaorigen=$prefix."ecommerce_tblsubcategoriasxcategoria";
$rr="default.php";
$idx=$_REQUEST['idx'];
...
$totalregistros=$result->RecordCount();
  ...
  $rutamodulo.="  <a href='default.php' class='textlink'>Listado Subcategorias </a>  /  <span class='text1'>$titulomodulo</span>";
...
<td colspan="2">
<strong>RELACIONES.</strong> Asocie Un Producto:
<?
$datasqladd=" and idactivo not in(2,9)";
include($rutxx."../relaciones/default.precio.php");?>
</td>
</tr>

<tr valign=top bgcolor="#FFFFFF">
<td colspan="2">
<strong>Aplicar  Sobre Precio.</strong>
<br>
