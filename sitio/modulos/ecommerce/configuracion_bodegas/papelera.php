...
$titulomodulo="Papelera de Badega";
$titulomodulo2="Configuracion de Bodega";
$letra=$_REQUEST['letra'];
$tabla="tblbodegas";
$orderby=$_REQUEST['orderby'];
$dsruta="../configuracion_bodegas/default.php";//ruta para los logs
...
$sql="select a.id,a.dsciudad as dsm,a.idpos,a.idactivo from $tabla a where idactivo=9 ";
