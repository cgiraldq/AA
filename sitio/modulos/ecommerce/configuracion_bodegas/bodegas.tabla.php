...
$nombrecampos="Id,Nombre bodega,Pais,Departamento,Ciudad,Direccion,Telefono,Activo?";
	...
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <input type="text" name="id_[]" value="<? echo $result->fields[0]?>" size="2" readonly class="textnegro">
			  ...
			  <td align="center">
		  <input type="text" name="dsm_[]" value="<? echo $result->fields[7]?>" size="30" class="textnegro" maxlength="100">
			</td>
	  ...
	  <td align="center">
		  ...
		  <input type="text" name="dsciudad_[]" value="<? echo $result->fields[1]?>" size="30" class="textnegro" maxlength="100">
				  ...
				  <td align="center">
		  <input type="text" name="dsdir_[]" value="<? echo $result->fields[3]?>" size="10" class="textnegro" maxlength="100">
			</td>
	


				  <td align="center">
		  <input type="text" name="dstel_[]" value="<? echo $result->fields[6]?>" size="10" class="textnegro" maxlength="100">
			</td>
