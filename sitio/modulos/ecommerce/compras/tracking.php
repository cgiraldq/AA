...
$rr="default.php";
$tabla="ecommerce_tblpagos_tracking";			
...
$idx=$_REQUEST['idx'];
  if ($idx<>"") { 
    $sql=" delete from ecommerce_tblpagos_novedades WHERE id='$idx' ";
    if ($db->Execute($sql))  { 
...
// novedades
$novedades=0;
$sql="select count(*) as total from ecommerce_tblpagos_novedades where idpedido=$idpedido";
