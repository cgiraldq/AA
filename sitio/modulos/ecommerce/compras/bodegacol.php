...
$titulomodulo="Pedido en Bodega Origen";
$rr="default.php";
...
El presente mensaje es con fin de notificarle que hemos recibido en nuestra bodega de miami el pedido con referencia -Idpedido-.

";

// $db->debug=true;
$sql="select a.idpedido,a.dsfechalarga,dscausa_b,dsfecha_b from $tabla a where ";//and idestado<>0";
$sql.=" id=".$id;
