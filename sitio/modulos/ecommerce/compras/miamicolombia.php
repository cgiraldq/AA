...
$titulomodulo="Pedido desde bodega en miami a miami";
$rr="default.php";
...
El presente mensaje es con fin de notificarle el pedido con referencia -Idpedido- se encuentra en transito desde nuestras bodegas en Miami hacia colombia.

";

// $db->debug=true;
$sql="select a.idpedido,a.dsfechalarga,dscausa_mc,dsfecha_mc from $tabla a where ";//and idestado<>0";
$sql.=" id=".$id;
