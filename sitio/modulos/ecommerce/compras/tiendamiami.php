...
| ----------------------------------------------------------------- | 
*/
// pedido desde tienda hacia miami
...
$titulomodulo="Pedido desde tienda a bodega en miami";
$rr="default.php";
...
El presente mensaje es con fin de notificarle el pedido con referencia -Idpedido- se encuentra en transito desde la tienda hacia las bodegas en Miami.

";

// $db->debug=true;
$sql="select a.idpedido,a.dsfechalarga,dscausa_tm,dsfecha_tm from $tabla a where ";//and idestado<>0";
$sql.=" id=".$id;
...
<input type="hidden" name="tiendamiami" value="1">
</td></tr>
</form>
