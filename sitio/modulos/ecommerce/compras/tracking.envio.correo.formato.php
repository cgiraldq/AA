...
$asunto=preg_replace("/-Idpedido-/",$idpedido,$asunto);
$asunto=preg_replace("/-origen-/",$idpedido,$bodega[0]);
$asunto=preg_replace("/-destino-/",$idpedido,$bodega[1]);
$asunto=preg_replace("/\n/","<br>",$asunto);

// control del texto
$dsobs=preg_replace("/-Nombre-/",$dsnombres." ".$dsapellidos,$dsobs);
$dsobs=preg_replace("/-Idpedido-/",$idpedido,$dsobs);
$dsobs=preg_replace("/-origen-/",$bodega[0],$dsobs);
$dsobs=preg_replace("/-destino-/",$bodega[1],$dsobs);
$dsobs=preg_replace("/\n/","<br>",$dsobs);
