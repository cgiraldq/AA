...
$nombrecampos="Id,Num Pedido,Cliente,Fecha,Titulo,Descripcion,Tipo,Envio al cliente";
...
$contar=0;
	while (!$result->EOF) {
		...
		<td align="center">
			<? 
			if ($result->fields[6]=="1") echo "Garantia";
			if ($result->fields[6]=="2") echo "Devolucion";
			if ($result->fields[6]=="3") echo "Cerrar garantia";
			if ($result->fields[6]=="4") echo "Cerrar devolucion";
			?>
		</td>
