...
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="ecommerce_tblcuepocorreo";

$tablarelaciones2="ecommerce_tblayudaxtblempresa";
$tablaorigen2="tblempresa";

$rutaImagen="../../../../contenidos/images/ecommerce_correo/";
// rutas repro
			...
			if ($paso=="1") {
				...
				//exit();
					...
					if ($db->Execute($sql))  {
						...
						$dsruta="../ecommerce/cuerpocorreo/default.php";
