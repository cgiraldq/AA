...
$titulomodulo="Configuracion de Formas de pagos";
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="tblformasdepagos";
$carpeta="categoria";
...
$sql="select a.dsm,a.dsd,a.idpos,a.idactivo,a.dsimg1,a.dsd2";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
...
<input type=text name=dsd size=45 maxlength="255" class=text1 onKeyPress="ocultar('capa_dsd')" value="<? echo $dsd?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
<?
$nombre_capa="capa_dsd";
$mensaje_capa="Debe ingresar la plantilla";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");?>
</td>
</tr>
...
<td>
	<select name=idactivo class=text1>
		  ...
		  <option value="3" <? if ($idactivo==3) echo "selected";?>>Pago virtual</option>
