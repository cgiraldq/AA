...
$titulomodulo="Papelera de Condiciones de pagos";
$titulomodulo2="Configuracion de Condiciones de pagos";
$letra=$_REQUEST['letra'];
$tabla="tblcondicionesdepago";
$orderby=$_REQUEST['orderby'];
$dsruta="../condicionesdepagos/default.php";//ruta para los logs
