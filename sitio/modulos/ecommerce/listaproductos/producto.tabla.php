...
<form action="<? echo $paginao;?>" method=post name=p>
	<!--tr>
		<td colspan=12>
			<table  cellpadding="2" cellspacing="1" align="center" class="text1">
			<tr>
			<td>
			<input type=button name=enviary value="Lista de productos con fechas" onClick="irAPaginaD('default.producto.fechas.php?idtipoprod=<? echo $idtipoprod?>')"  class="btn_barra">
			</td>
			<td>
			<input type=button name=enviary value="Lista de productos importados" onClick="irAPaginaD('default.importacion.producto.php?idtipoprod=<? echo $idtipoprod?>')"  class="btn_barra">
			</td>
			<td>
			<input type=button name=enviary value="Lista de productos con precio de compra" onClick="irAPaginaD('default.producto.preciocompra.php?idtipoprod=<? echo $idtipoprod?>')"  class="btn_barra">
			</td>
			<td>
			<input type=button name=enviary value="Lista de productos inativos" onClick="irAPaginaD('default.inativo.php?idtipoprod=<? echo $idtipoprod?>')"  class="btn_barra">
			</td>
			<td>
			<input type=button name=enviary value="Orden productos" onClick="irAPaginaD('ordenar.php')"  class="btn_barra">
			</td>
			</tr>
			</table>
		</td>
...
$contar=0;
	...
	//	echo $sql;
		...
		<td align="center">
			<a href="../../../ecommerce.productos.detalle.php?vistaprevia=1&idproducto=<? echo $result->fields[0]?>&idtipoprod=<? echo $idtipoprod?>" target="_blank">
				Vista previa
			</a>
			|
		   <?
