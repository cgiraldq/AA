...
$titulomodulo="Configuracion de Monedas";
$dsm=$_REQUEST['dsm'];
		...
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			$mensajes=$men[0];
		 	...
		 	// insertar
			$sql="insert into $tabla (dsm,idvalor,idactivo)";
			$sql.=" values ('$dsm',$idvalor,'$idactivo') ";
			if ($db->Execute($sql))  { 
				$error=0;
...
$sql="select a.id,a.dsm,a.idvalor,a.idactivo from $tabla a where id>0 and a.idactivo<>9 ";
//echo $sql;
...
//echo $sql;
	...
	$rutamodulo="<a href='../../core/default.php' class='textlink' title='Principal'>Principal</a>  /  ";
		...
		$dsrutap="../ecommerce/monedas/default.php";
