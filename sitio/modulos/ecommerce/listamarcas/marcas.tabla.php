...
$rutaImagen="../../../../contenidos/images/marcas/";
		 ...
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <input type="text" name="id_[]" value="<? echo $result->fields[0]?>" size="2" readonly class="textnegro">
				...
				<?$dsimg=$result->fields[2];
				 ...
				 <a class="customlightbox" title="Click para ver la imagen" href="<? echo $rutaImagen.$dsimg;?>" rel="group2">
		      		<img src="<? echo $rutaImagen.$dsimg;?>" width="100" heigth="100">
            	</a>
		  ...
		  <td align="center">
		  <input type="text" name="idpos_[]" value="<? echo $result->fields[3]?>" onkeypress="return numero(event);"  size="2" class="textnegro" maxlength="8">
			</td>
		  ...
		  <td align="center">
			  <select name="idactivo_[]" class="textnegro">
				  ...
				  <option value="3" <? if ($result->fields[4]==3) echo "selected";?>>DESTACADA</option>					  	
			  </select>
		  </td>
		  ...
		  <td align="center">
		  <?
		  $rutax="marcas.editar.php?idx=".$result->fields[0];
