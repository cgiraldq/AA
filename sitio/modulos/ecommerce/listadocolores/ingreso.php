...
?>
<br>
<table align="center"  cellspacing="1" cellpadding="1" border="0" width=70% class="texto_parrafo2" bgcolor="#CCCCCC">
...
<input type=color name=dsd size=60 maxlength="255" class=text1 onKeyPress="ocultar('capa_dsd')"  <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
</td>
...
$mensaje_capa="Debe ingresar el color";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");
?>
</td>
