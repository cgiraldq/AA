...
$nombrecampos="Id,Nombre,Color,Posici&oacute;n,Activo";
...
$contar=0;
	while (!$result->EOF && ($contar<$maxregistros)) {
	  ...
	  <td align="center">
		  	<input type="color" name="dsd_[<? echo $contar?>]" value="<? echo $result->fields[3]?>" size="10" class="textnegro" maxlength="20" title="Click Para Editar color">
			</td>
