...
$rc4 = new rc4crypt();
$titulomodulo="Configuracion de Despachos";
...
$sql.=",a.idpedido,a.idclientepago,a.dsdescuento,a.dsfechalarga,a.dscampo1,a.idtienda,a.dsciudadorigen,a.dsciudadestino,a.totalvalorguia,a.idserviciotrans,a.transporte";
$sql.=",b.idcant,b.id,a.iddespachado";
$sql.=" from $tabla a ";
 $sql.=", ecommerce_tblcompras b ";
$sql.=" where a.id>0  and a.idestado=4 and b.idpedido=a.idpedido  and a.idtipocomp<>66666666666";//and idestado<>0";
if ($idproducto<>"") $sql.="  ";
...
if($_REQUEST['idcliente']<>"")$sql.=" and a.idcliente=".$_REQUEST['idcliente'];
...
if ($orderby<>"") { 
	...
	if ($idproducto<>"")   $rutamodulo.=" / <a href='../despachos/default.consolidados.confirmados.php' class='textlink' title='Regresar'>Regresar a Productos Consolidados Confirmados</a>  /  ";

  $rutamodulo.=" / <a href='../despachos/default.consolidados.confirmados.php' class='textlink' title='Consolidado'>Productos Consolidados Confirmados</a>  /  ";
