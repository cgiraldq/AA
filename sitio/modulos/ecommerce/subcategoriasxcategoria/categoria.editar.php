...
$carpeta="subcategoriaxcategoria";
$rutaImagen="../../../../contenidos/images/ecommerce_subcategoriaxcategoria/";
$tablarelacionesx="ecommerce_tblcategoriaxsubcategoria";
			...
			if ($paso=="1") {
				...
				//	echo $sql;
					...
					if ($db->Execute($sql))  {
						...
						$dsruta="../ecommerce/sucategoriaxcategoria/default.php";
...
$sql="select a.dsm,a.dsd,a.idpos,a.idactivo,a.dsimg1,a.idnat,a.idcategoria,a.dsalias";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
...
<tr valign=top bgcolor="#FFFFFF">
<td>Imagen<br>Tama&ntilde;o 200 x 200</td>
...
<td>
 <select name="idcategoria" class="textnegro">
            <? //listar_categorias("tblcategoria",$idcategoria); ?>
          </select>
...
<?
$datasqladd=" and id>1 ";
include($rutxx."../relaciones/default.empresa.php");?>
</td>
</tr>
