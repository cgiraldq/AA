...
$nombrecampos="Id,Imagen,Nombre,Alias,Posici&oacute;n";
$nombrecampos.=",Activo";
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <input type="text" name="dsm_[]" value="<? echo $result->fields[1]?>" size="40" class="textnegro" maxlength="100">
			  ...
			  <td align="center">
		  <input type="text" name="dsalias_[]" value="<? echo $result->fields[7]?>" size="40" class="textnegro" maxlength="100">
			</td>
		  ...
		  <select name="idnat_[]" class="textnegro">
			...
			<option value="2" <? if ($result->fields[5]==2) echo "selected";?>>Importado</option>
				...
				<? } ?>
					...
					<?// listar_categorias("tblcategoria",$result->fields[6]); ?>
					</select>
				</td-->
