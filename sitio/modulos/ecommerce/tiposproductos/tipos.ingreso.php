...
<tr valign=top bgcolor="#FFFFFF">
<td>Plantilla asociada</td>
<td>
<? $contadorx="dsd_counter";$valorx="255";$formax="u";$campox="dsd";?>
<input type=text name=dsd size=60 maxlength="255" class=text1 onKeyPress="ocultar('capa_dsd')" value="<? echo $dsd?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>

<?
$nombre_capa="capa_dsd";
$mensaje_capa="Debe ingresar la plantilla asociada";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");
?>
</td>
...
<tr valign=top bgcolor="#FFFFFF">
<td>Plantilla asociada otros producto</td>
<td>
<? $contadorx="dsd2_counter";$valorx="255";$formax="u";$campox="dsd2";?>
<input type=text name=dsd2 size=60 maxlength="255" class=text1 onKeyPress="ocultar('capa_dsd2')" value="<? echo $dsd2?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>
