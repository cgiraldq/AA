...
$titulomodulo="Papelera de Tipos de Productos";
$titulomodulo2="Configuracion de Tipos de Productos";
$letra=$_REQUEST['letra'];
$tabla="tbltiposproductos";
$orderby=$_REQUEST['orderby'];
$dsruta="../tiposproductos/default.php";//ruta para los logs
