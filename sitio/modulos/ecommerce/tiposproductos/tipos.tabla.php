...
$nombrecampos="Id,Nombre,Plantilla,Plantilla otros,Posici&oacute;n,Activo";
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <input type="text" name="dsm_[]" value="<? echo $result->fields[1]?>" size="40" class="textnegro" maxlength="100">
			  ...
			  <td align="center">
		  <input type="text" name="dsd_[]" value="<? echo $result->fields[4]?>" size="40" class="textnegro" maxlength="255">
			</td>
			<td align="center">
		  	<input type="text" name="dsd2_[]" value="<? echo $result->fields[5]?>" size="40" class="textnegro" maxlength="255">
			</td>
		  ...
		  <td align="center">
		   <?
		  $rutax="tipos.editar.php?idx=".$result->fields[0];
