...
$titulomodulo="Configuracion de Tipo de Producto";
$dsm=$_REQUEST['dsm'];
$dsd=$_REQUEST['dsd'];
...
$tabla="ecommerce_tbltiposproductos";
		...
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			$mensajes=$men[0];
		 	...
		 	// insertar
			$sql="insert into $tabla (dsm,dsd,idpos,idactivo,dsd2)";
			$sql.=" values ('$dsm','$dsd',$idpos,$idactivo,'$dsd2') ";
			if ($db->Execute($sql))  { 
				$error=0;
...
$sql="select a.id,a.dsm,a.idpos,a.idactivo,a.dsd,a.dsd2 from $tabla a where id>0 and idactivo<>9";
...
$result=$db->PageExecute($sql,$maxregistros,$pagina_actual);
	if (!$result->EOF) {
		...
		include("tipos.tabla.php");
		include($rutxx."../../incluidos_modulos/paginar.php");
	} // fin si 
$result->Close();
	include("tipos.ingreso.php");
