...
// cargando datos
$sql="select a.id,a.dsm,a.dsd,a.idactivo,a.dsimg,a.dsimg2,a.idcategoria,a.dsruta,a.dsfechain,a.dsd2,a.idautor,a.dsmingles,a.dsdingles,a.dsdlargoingles from ".$tabla." a where id=".$idx;
...
<?}?>
		...
		<option value="1" <? if ($campov3==1) echo "selected";?>>SI</option>
