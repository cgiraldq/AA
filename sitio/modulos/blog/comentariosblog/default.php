...
$titulomodulo="Listado de comentarios del blog";
$letra=$_REQUEST['letra'];
$idtema=$_REQUEST['idtema'];
$idrespuesta=$_REQUEST['idrespuesta'];

$tabla="blogtblcomentarios";
// insercion
// eliminacion
$idx=$_REQUEST['idx'];
if ($idx<>"") {
...
if ($idtema<>"") $sql.=" and a.idr='$idtema'";
...
//echo $sql;
	...
	$rutamodulo.="<a href='../blog/default.php' class='textlink' title='Configuraci&oacute;n de blog'>Configuraci&oacute;n de blog</a>  / <span class='text1'>".$titulomodulo."</span>";
