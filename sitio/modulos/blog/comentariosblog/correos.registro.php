...
$titulomodulo="Listado de correos";
...
$sql="select a.id,a.dsnombre,a.dsapellidos,a.dsempresa";
$sql.=",a.dstel,a.dsdireccion,a.dsciudad,a.dscorreocliente,a.dscom,a.dsfecha,a.dsreferido,a.dsremoto";
if($tipo==2)$sql.=",b.dsm ";
if($tipo==3)$sql.=",b.dsm,b.dsapellidos ";
$sql.=" from $tabla a ";
...
$sql.=" order by a.id desc  ";
	// modulo buscador
		...
		$paramb="dsnombre,dsapellidos,dsmail";
