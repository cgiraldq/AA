...
$nombrecampos="Id,Tipo Votacion,Nombre,Activo";
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <input type="text" name="id_[]" value="<? echo $result->fields[0]?>" size="2" readonly class="textnegro">
			  ...
			  <td align="center">
			  <strong><? echo $result->fields[4]?></strong>
		  <!--<input type="hidden" name="idtv_[]" value="<? //echo $result->fields[3]?>" size="30" class="textnegro" maxlength="100">-->
			</td>
		  ...
		  <td align="center">
			<?
			$trutax="Click para asociar Preguntas";
			$mrutax="Preguntas";
		  	$rutax="fichatecnica.preguntas.php?idtv=".$idtv."&idy=".$result->fields[0];
		  	include($rutxx."../../incluidos_modulos/enlace.generico.php");?>
		  	|
		  	<?
			$rutax="fichatecnica.editar.php?idtv=".$idtv."&idx=".$result->fields[0];
		  	include($rutxx."../../incluidos_modulos/enlace.detalles.php");?>
		  	|
		  	<?
			$rutax=$pagina."?idtv=".$idtv."&idx=".$result->fields[0];
			$formax="";
