...
$nombrecampos="Id,Ubicacion,Centro Atencion,Zona electoral,Maximo votos,Maximo Ganadores,Activo";
...
$contar=0;
	...
	<td align="center">
		  <input type="text" name="centroatencion_[]" value="<? echo $result->fields[5]?>" size="30" class="textnegro" maxlength="100">
			</td>
	<td align="center">
		  <input type="text" name="zona_[]" value="<? echo $result->fields[6]?>" size="30" class="textnegro" maxlength="100">
			</td>
	
	
	
		  <td align="center">
		  <input type="text" name="votos_[]" value="<? echo $result->fields[3]?>" size="5" class="textnegro" maxlength="8">
			</td>
			
			<td align="center">
		  <input type="text" name="ganadores_[]" value="<? echo $result->fields[4]?>" size="5" class="textnegro" maxlength="8">
			</td>
