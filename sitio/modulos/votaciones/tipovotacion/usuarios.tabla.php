...
$nombrecampos="Id,Nombre,Login,Clave,Activo";
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <input type="text" name="dsm_[]" value="<? echo $result->fields[1]?>" size="30" class="textnegro" maxlength="100">
			 ...
			 <td align="center">
		  <input type="text" name="dslogin_[]" value="<? echo $result->fields[3]?>" size="30" class="textnegro" maxlength="100">
			</td>
			
			<td align="center">
		  <input type="password" name="dsclave_[]" value="<? echo $result->fields[4]?>" size="30" class="textnegro" maxlength="100">
			</td>
