...
$titulomodulo="Fechas de escrutinios";
$idtv=$_REQUEST['idtv'];
...
$tabla="tblvotacionfechaescrutinios";
// insercion
...
//echo $sql;
	...
	$dsrutap="../votaciones/tipovotacion/escrutinios.php";
	$rutavotaciones="../";
	$idy=$_REQUEST['idtv'];
	$papelera=1;
...
$result=$db->PageExecute($sql,$maxregistros,$pagina_actual);
	if (!$result->EOF) {
		...
		include("escrutinios.tabla.php");
		include($rutxx."../../incluidos_modulos/paginar.php");
	} // fin si
$result->Close();
	include("escrutinios.ingreso.php");
