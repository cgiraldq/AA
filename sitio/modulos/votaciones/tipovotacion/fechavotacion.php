...
$titulomodulo="Fechas de votaci&oacute;n";
$idtv=$_REQUEST['idtv'];
...
$tabla="tblvotacionfechavotacion";
// insercion
...
$sql="select a.id,a.dsfechainicial,dshorainicial,dsfechafinal,dshorafinal,dsrequisitos,a.idactivo,a.idhorai,a.idhoraf from $tabla a where idtv=".$idtv;
...
//echo $sql;
	...
	$dsrutap="../votaciones/tipovotacion/fechavotacion.php";
	$rutavotaciones="../";
	$idy=$_REQUEST['idtv'];
	$papelera=1;
...
$result=$db->PageExecute($sql,$maxregistros,$pagina_actual);
	if (!$result->EOF) {
		...
		include("fechavotacion.tabla.php");
		include($rutxx."../../incluidos_modulos/paginar.php");
	} // fin si
$result->Close();
	include("fechavotacion.ingreso.php");
