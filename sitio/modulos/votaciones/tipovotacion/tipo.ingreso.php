...
<input type=text name=dsm size=60 maxlength="255" class=text1 onKeyPress="ocultar('capa_dsm')" value="<? echo $dsm?>"
...
<td>
  <select name=idarchivo class=text1>
      <!--option value="0" <? if ($idarchivo==0) echo "selected";?>>---</option-->
      <option value="1" <? if ($idarchivo==1) echo "selected";?>>SI</option>
      <!--option value="2" <? if ($idarchivo==2) echo "selected";?>>NO</option-->
  </select>
