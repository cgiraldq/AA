...
$maxregistros=10;
$sql="select dsnombre,dsapellidos,dstelefono,dscorreocliente,dsfecha from tblcontacto_corporativo order by id desc ";
//echo $sql;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
    <tr>
     <td align="left" valign="middle" class="titulo_index">
       <h1> &Uacute;ltimos <? echo $maxregistros?> Correos para solicitud de servicios</h1>
      </td>
    </tr>
</table>
                ...
                <td height="20" align="center" valign="middle" bgcolor="#F7F7F7"><table width="100%">
                  ...
                  <tr class="texto_normal2" align="center" valign="top"  bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');">
                    <td align="center" valign="top" class="texto_normal2">
                      <a href="../crm/contactenos_servicios/default.php" class="textazullink" title="Ir al modulo de correos"><? echo $result->fields[0];?> <? echo $result->fields[1];?></a></td>
