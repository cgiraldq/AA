...
$titulomodulo="Configuraci&oacute;n web service";
$dsnombre=$_REQUEST['dsm'];
$idpos=$_REQUEST['idpos'];
$idactivo=$_REQUEST['idactivo'];
$letra=$_REQUEST['letra'];
$tabla="crmtblwebservices";
		...
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			$error=1;
		 	...
		 	// insertar
			$sql="insert into $tabla (dsm,idactivo,idpos)";
...
$sql="select a.id,a.dsm,a.idactivo,idpos from $tabla a where a.idactivo not in(9) ";
...
include("web.tabla.php");

} // fin si
$result->Close();
include("web.ingreso.php");
