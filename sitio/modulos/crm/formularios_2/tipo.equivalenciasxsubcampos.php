...
$tabla="framecf_tbltiposformulariosxequivalenciasxsubcampos";


$papelera=5;
$pruta="formulario";
include("proceso.equivalenciasxsubcampos.php");
?>
<html>
...
$sql.=" from $tabla a where id>0 and idactivo not in(9) and idcampo=$idx and idtipoformulario=$idx2 and idsubcampo=$idx3";
...
// fin modulo buscador
	...
	$rutamodulo.="<a href='../formularios/tipo.default.php?idx=$idx&idx2=$idx2' class='textlink' title='Listado de los campos que componen el formulario'>Listado de los subcampos</a>  / ";
