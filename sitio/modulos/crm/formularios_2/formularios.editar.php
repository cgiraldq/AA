...
$tablarelaciones1="tblrelacionesxtblformularios";
	...
	$dscorreo3=$_REQUEST["dscorreo3"];
			...
			if ($paso=="1") {
					...
					$sql.=" ,idcaptcha='$idcaptcha'";
					$sql.=" ,idterminos='$idterminos'";
					$sql.=" ,idremate='$idremate'";
...
$sql.=",dscantimagenes,idgaleriaoblig,dscantimagenesmostrar,a.idcaptcha,a.idterminos,a.idremate ";
...
$idcaptcha=$result->fields[22];
$idterminos=$result->fields[23];
$idremate=$result->fields[24];
...
<tr valign="top" bgcolor="#FFFFFF">
	<td>Mostar titulo del formulario en la pagina web</td>
...
<tr valign="top" bgcolor="#FFFFFF">
	<td>Mostar descipci&oacute;n del formulario en la pagina web </td>
	<td>
...
<tr valign="top" bgcolor="#FFFFFF">
	<td>Activar capchat ?</td>
	<td>
		<select name="idcaptcha" class="text1" OnChange="mostar_capa_informes('idcaptcha');" >

		  <option value="1" <? if ($idcaptcha==1) echo "selected";?>>SI</option>
		  <option value="2" <? if ($idcaptcha==2) echo "selected";?>>NO</option>

		</select>
	</td>
</tr>
<tr valign="top" bgcolor="#FFFFFF">
	<td>Activar Terminos y condiciones ?</td>
	<td>
		<select name="idterminos" class="text1" OnChange="mostar_capa_informes('idterminos');" >

		  <option value="1" <? if ($idterminos==1) echo "selected";?>>SI</option>
		  <option value="2" <? if ($idterminos==2) echo "selected";?>>NO</option>

		</select>
	</td>
</tr>
<tr valign="top" bgcolor="#FFFFFF">
	<td>Mostrar informacion de contacto en el remate del formulario ?</td>
	<td>
		<select name="idremate" class="text1" OnChange="mostar_capa_informes('idremate');" >

		  <option value="1" <? if ($idremate==1) echo "selected";?>>SI</option>
		  <option value="2" <? if ($idremate==2) echo "selected";?>>NO</option>
...
<tr valign="top" bgcolor="#F3F3F3">
	<td>Mostar informe de ultimos registros en principal del sistema </td>
...
<td colspan="2">
<strong>RELACIONES.</strong> Elegir los campos a mostar en el reporte:
<?
...
function mostar_capa_informes(estado){
 ...
 mostar_capa_informes('idinformes');
