...
//$rc4 = new rc4crypt();
//$db->debug=true;
$rr="formularios.campos.agrupar.temas.php?idxx=".$_REQUEST["idxx"];

$dstema=seldato("dsm","id","framecf_tbltiposformulariosxcamposxagrupamientoxtemas",$_REQUEST['idx'],2);
$titulomodulo="Agrupamiento ( $dstema )";


$tablarelaciones="tblagrupamientoxtblformulariosxtemas";
...
$totalregistros=$result->RecordCount();
	...
	$rutamodulo.="<a href='$rutxx../crm/formularios/formularios.campos.agrupar.temas.php?idxx=$idxx' class='textlink' target='_top' title='Agrupamiento de campos por temas'>Agrupamiento de campos por temas</a>";
