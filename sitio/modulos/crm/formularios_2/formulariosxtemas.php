<table align="center"  cellspacing="1" cellpadding="1" border="0" width=98% class="campos_ingreso" id="detalle">
...
?>
<tr style="background:gray"><td  align="center" colspan="4"><h1><? echo $dsmx;?></h1></td></tr>
<?
//$param="";
$contador=0;
	while(!$resultx->EOF){
