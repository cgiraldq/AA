...
<input type=submit name=idy value="<? echo $idy?>">
<input type=submit name=idz value="<? echo $idz?>">

<input type=submit name=dsy value="<? echo $dsy?>">
<input type=submit name=dsz value="<? echo $dsz?>">
