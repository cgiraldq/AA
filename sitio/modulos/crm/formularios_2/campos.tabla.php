...
$nombrecampos="Nombre,Mensaje Cuando es Obligatorio,Descripcion,Activo,Publicar <br>en la Web,Publicar en<br>listado<br>registros,Tipo,Campo Obligatorio,Posici&oacute;n ,Campo de referencia<br> del formulario,Campo activar <br>en el selecionador,Activar En buscadores?";
...
$maxregistros=500;
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		|
		  ...
		  $rutax=$pagina."?idy=".$result->fields[0]."&idx=".$result->fields[9];
		  $formax="";
