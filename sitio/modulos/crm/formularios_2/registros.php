...
$tabla=$prefix."framecf_tblregistro_formularios";
$tablax=$prefix."framecf_tbltiposformulariosxcampo";
// eliminacion
if ($idx<>"") {
...
$sql="select a.idactivo,a.clasgratis,a.idusuario,a.id,a.idagrupamiento,";
