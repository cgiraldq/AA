...
$titulomodulo="Configuraci&oacute;n de categor&iacute;a de actividades";
$dsnombre=$_REQUEST['dsm'];
$idpos=$_REQUEST['idpos'];
$idactivo=$_REQUEST['idactivo'];
$letra=$_REQUEST['letra'];
$tabla="crmtblactividadesxcategoria";
...
$sql="select a.id,a.dsm,a.idactivo,idtipo from $tabla a where a.idactivo not in(9) ";
