...
$titulomodulo="Papelera de actividades";
$titulomodulo2="Configuraci&oacute;n de actividades";
...
$sql="select a.id,a.dsm,a.idtipo,a.idactivo from $tabla a where idactivo=9 ";
