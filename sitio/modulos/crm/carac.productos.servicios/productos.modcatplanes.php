...
$titulomodulo="Configuracion del detalle de categoria de planes";
...
if ($_REQUEST['inn']==1){
	...
	$archivoanterior2=$_REQUEST['archivoanterior2'];
			...
			if ($_FILES['dsarchivo1']['name']<>"") {
				// borrar anterior
				//echo $archivoanterior=$_REQUEST['archivoanterior'];
...
// cargando datos
$sql="select * from $tabla where id=".$idcampo;
//echo $sql;
...
<body >
	<?
		...
		$rutamodulo.=" <a href='productos.categorias.php' class='textlink' title='Principal'><span class='text1'>".$titulopremodulo."</span></a> / ";
...
<section class="cont_general">
		...
		<table width=70% align=center cellspacing=0 class="campos_ingreso">
		...
		<form action="<? echo $pagina;?>" method=post name=u enctype="multipart/form-data">
			<tr >
				...
				<td valign=top>
					<input type="text" name="campo0" value="<? echo $campov0;?>" size=80 maxlength="255">
				</td>
			</tr>
		...
		<td valign=top>
		<textarea name="campo1" cols="80" rows="15"><? echo $campov1;?></textarea>
		</td>
		</tr>
		...
		<tr >
		<td valign=top >
			<strong><? echo utf8_decode($camposN[4]);?></strong>
		</td>
		<td valign=top>
		...
		<nav class="nav_centro">
			<input type=button name=enviar value="Modificar" class="botones" class="btn_detalle botones2" onClick="valI();">
			<input type=button name=enviar value="Regresar" class="botones" onClick="irAPaginaD('productos.catplanes.php');">
