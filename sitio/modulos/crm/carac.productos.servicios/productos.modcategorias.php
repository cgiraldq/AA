...
$titulomodulo="Configuracion de categorias detalle";
...
// validaciones de datos
	...
	$camposN[0]="Nombre (m&aacute;ximo 32 caracteres )";
	...
	// actualizando
			...
			$strSQL="update tblproductosxcategorias";
			$strSQL.="  set ";
			$strSQL.=" dsm='$campo0',dsdescripcion='$campo1',idactivo='$campo2',dsfoto='$nombre1',dsruta='$dsruta'";
...
// cargando datos
$sql="select * from tblproductosxcategorias where id=".$idcampo;
...
<? include ("../../incluidos/resultoperaciones.php"); ?>
		...
		<tr bgcolor="<? echo $fondos[4];?>">
			...
			<td valign=top>
				<input type="text" name="campo0" class=textnegro2 value="<? echo $campov0;?>" size=80 maxlength="32">
			</td>
		</tr>
		...
		<tr bgcolor="<? echo $fondos[12];?>" align=center>
			...
			<input type=button name=enviar value="Regresar" class="btn_detalle botones2" onClick="irAPaginaD('productos.categorias.php');">
