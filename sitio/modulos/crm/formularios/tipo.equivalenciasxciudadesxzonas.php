...
$tabla=" framecf_tbltiposformulariosxequivalenciasxciudadesxzonas";


$papelera=5;
$pruta="formulario";
include("proceso.equivalenciasxciudadesxzonas.php");
?>
<html>
...
$sql.=" from $tabla a where id>0 and idactivo not in(9) and idcampo=$idx and idtipoformulario=$idx2 and idsubcampo=$idx3 and idzonas=$idx4";
...
// fin modulo buscador
	...
	$rutamodulo.="<a href='../formularios/tipo.ciudad.php?idx=$idx&idx2=$idx2' class='textlink' title='Listado de los campos que componen el formulario'>Listado de los ciudades</a>  / ";
