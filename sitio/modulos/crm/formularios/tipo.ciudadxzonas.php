...
$tabla="framecf_tbltiposformulariosxzonasxciudades";
 $idxx=$_REQUEST['idxx'];
 $idy=$_REQUEST['idxy'];
$idx2=$_REQUEST['idxy'];
$dsm1=$_REQUEST['dsm1'];
...
$papelera=22;
$pruta="formulario";
include("proceso.tipociudadxzonas.php");
?>
<html>
...
// fin modulo buscador
	...
	$rutamodulo="<a href='../formularios/formularios.campos.configurar.php?dstoken=$dstokenvalidador&idx=$idxyy' class='textlink' title='Listado de los campos que componen el formulario pedido'>Listado de los campos </a>  / ";

	$rutamodulo.="<a href='../formularios/tipo.ciudad.php?idx=$idxx&idx2=$idxyy' class='textlink' title='$titulomodulo'> ".$titulomodulo." </a>";

		$dsmzona=seldato("dsm","id","framecf_tbltiposformulariosxcampos",$idxyz,2);
	$rutamodulo.=" / Listado de Zonas por ( $dsmzona )";

		include("tipo.tablaciudadxzonas.php");
