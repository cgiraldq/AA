...
if ($dsm<>"") {
		$sql="select dsm ";
	 	$sql.=" from $tabla WHERE dsm='$dsm' and idcampo=$idxyz ";
	 	//echo $sql;
		 ...
		 if (!$result->EOF) {
			...
			$mensajes=$men[0];
		 	...
		 	// insertar
			$sql="insert into $tabla (dsm,idactivo,idcampo,idtipoformulario,dsvalor,idcodigo)";
			$sql.=" values ('$dsm','$idactivo',$idxyz,$idxyy,'$dsm1','$idcodigo') ";
			//echo $sql;
			$error=0;
