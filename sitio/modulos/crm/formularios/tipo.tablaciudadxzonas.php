...
$contar=0;
	while (!$result->EOF && ($contar<$maxregistros)) {
		...
		<td align="center">
		 ...
		 $rutax="tipo.equivalenciasxciudadesxzonas.php?idx=".$_REQUEST['idxx']."&idx2=".$_REQUEST['idxyy']."&idx3=".$_REQUEST['idxyz']."&idx4=".$result->fields[0];
		...
		echo "| ";
		  		 ...
		  		 $rutax="tipo.ciudadxbarrios.php?idxx=".$result->fields[3]."&idxyy=".$idxyy."&idxyz=".$_REQUEST['idxx']."&dsm1=".$result->fields[1]."&idzona=".$result->fields[0];
		...
		<?
		  $rutax=$pagina."?idy=".$result->fields[0]."&idxyy=".$idxyy."&idxyz=".$_REQUEST['idxx']."&dsm1=".$result->fields[1]."&idzona=".$result->fields[0];
		  $formax="";
