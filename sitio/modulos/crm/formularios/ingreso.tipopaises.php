...
<tr valign=top bgcolor="#FFFFFF">
	...
	<td>
		<input type=text name=dsvalor size=1 maxlength="8" class=text1
		onKeyPress="ocultar('capa_dsvalor');return numero(event);" value="<? echo $dsvalor?>">
			<?
