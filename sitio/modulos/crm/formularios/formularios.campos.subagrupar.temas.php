...
$titulomodulo="Agrupamiento de temas por subtemas";
...
$tabla="framecf_tbltiposformulariosxcamposxsubagrupamiento";
// insercion
if ($dsm<>"" && $idpos<>"") {
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			$error=0;
		 	...
		 	// insertar
			$sql="insert into $tabla (dsm,idpos,idactivo,idformulario,idtema)";
			$sql.=" values ('$dsm',$idpos,$idactivo,$idxx,'$idtema') ";
			//echo $sql;
			if ($db->Execute($sql))  {
...
<body>
	...
	<? include($rutxx."../../incluidos_modulos/navegador.principal.php");
	 ...
	 $campoletra="dsm";
		...
		$dsrutap="../crm/formularios/formularios.campos.subagrupar.php";

		$rutamodulo="<a href='$rutxx../core/default.php' class='textlink' target='_top' title='Principal'>Principal</a>  /  ";
		$rutamodulo.="<a href='$rutxx../crm/formularios/default.php' class='textlink' target='_top' title='Listado de formularios activos para uso del sitio'>Listado de formularios activos para uso del sitio</a>";
		$rutamodulo.=" / <span class='text1'>".$titulomodulo."</span>";
		include($rutxx."../../incluidos_modulos/modulos.subencabezado.php");
// generacion del encabezado de acuerdo a los resultados encontrados
$sql="select a.id,a.dsm,a.idformulario,a.idpos,a.idactivo,a.idtienda,a.dsmalterna,idsitemap from $tabla a where idformulario='$idxx' and idactivo=1 and idtema=$idtema ";
...
$result=$db->PageExecute($sql,$maxregistros,$pagina_actual);
	if (!$result->EOF) {
		...
		include("tabla.subagrupar.php");
		include($rutxx."../../incluidos_modulos/paginar.php");
	} // fin si
$result->Close();
	include("ingreso.subagrupamiento.php");
