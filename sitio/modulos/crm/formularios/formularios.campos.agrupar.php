...
$titulomodulo="Agrupamiento de campos del fomulario";
...
$tabla="framecf_tbltiposformulariosxcamposxagrupamiento";
// insercion
if ($dsm<>"" && $idpos<>"") {
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			$error=0;
		 	...
		 	// insertar
			$sql="insert into $tabla (dsm,idpos,idactivo,idformulario,idcodigo)";
			$sql.=" values ('$dsm',$idpos,$idactivo,$idxx,'idcodigo') ";
			//echo $sql;
			if ($db->Execute($sql))  {
...
<body>
	...
	<? include($rutxx."../../incluidos_modulos/navegador.principal.php");
	 ...
	 $campoletra="dsm";
		...
		$dsrutap="../crm/formularios/formularios.campos.agrupar.php";
...
$sql="select a.id,a.dsm,a.idformulario,a.idpos,a.idactivo,a.idtienda,a.dsmalterna,idsitemap,idcodigo from $tabla a where idformulario='$idxx' and idactivo not in(9) ";
