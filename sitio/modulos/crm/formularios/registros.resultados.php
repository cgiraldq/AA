		...
		$h=0;
			for ($j=0;$j<$contarx;$j++){
				if ($_REQUEST['id_'][$j]<>""){
								...
								$sql.= "idbuscador=".$_REQUEST['idactivo_'][$j];
...
$sqlx.="and idactivo not in (2,9) and idpublicar=1 and idpublicardetalle=1 ";
 if($idxx==104) $sqlx.=" and dscampo!='dscampo2'";
$sqlx.=" order by idpos";
//echo $sqlx;
$nombrecampos="Codigo,Tipo,";
...
$sql="select a.idbuscador,a.clasgratis,a.idusuario,a.id,a.idagrupamiento,";
...
$separador="|";
	...
	include("registros.resultados.tabla.php");
