...
$result->Close();
			...
			$cuerpo='<table width="100%" cellspacing="2" cellpadding="1" class=text2 ID="Table2" bgcolor="'.$fondos[12].'">
			<tr align="center" valign="top">
				<td align="center" valign="top" bgcolor="'.$fondos[3].'" colspan="3" class="textnegrotit">
			<strong>'.nombre_dia_semana_ciclo(numero_dia_semana(intval($dia),intval($mes),$anio))." ".intval($dia)." de ".nombre_mes(intval($mes))." de ".$anio.", ".$dsc.'</strong>
				</td>
			</tr>';

			$cuerpo.='<tr align="center" valign="top" class="textnegro2" bgcolor="'.$fondos[12].'">
<td align="center" valign="top" bgcolor="'.$fondos[4].'" width="20%">Hora</td>
<td align="left" width="70%" valign="top" bgcolor="'.$fondos[4].'">Actividad</td>
			</tr>';
		 ...
		 //echo $sql;
			...
			$jj=0;
				...
				// echo $horai."-".$horaf."<br>";
					...
					if ($idhorabasei>=$horai && $idhorabasei<$horaf) {
						...
						$color=$fondos[3];
						if ($base==$xbase) {
						$cuerpo.='<tr align="center" valign="top" bgcolor="'.$color.'">';
						$cuerpo.='<td align="center" valign="top">'.$dshorabasem. " ".$int.'</td>';
						$cuerpo.='<td align="left" valign="top">';
						if ($base==$xbase) $cuerpo.=$basej;
						$cuerpo.='</td>';
						$cuerpo.='</tr>';
						}
						break 1;
			...
			$result->Close();
				...
				$cuerpo.='<tr align="center" valign="top">';
				$cuerpo.='<td align="center" width="'.$intervalo.'%" valign="top" bgcolor="'.$fondos[4].'" class="formabot"></td>';
				$cuerpo.='<td align="center" width="70%" valign="top" bgcolor="'.$fondos[4].'" class="formabot"></td>';
			$cuerpo.='</tr>';
			$cuerpo.='</table>';
$asuntoa="Su listado de actividades ".nombre_dia_semana_ciclo(numero_dia_semana(intval($dia),intval($mes),$anio))." ".intval($dia)." de ".nombre_mes(intval($mes))." de ".$anio.", ".$dsc;
//configuracion del correo
$rutbase=$rutxx;
$dscorreox=seldato("a.dscorreo","a.id"," tblusuarios a",$idusuariox." ",1);
$idx=0; // no depende de formularios
include($rutxx."../../incluidos_modulos/encabezado_correo.php");
include($rutxx."../../incluidos_modulos/enviadorcorreo.php");
//exit();
...
<!--
alert("Correo enviado a <? echo $dscorreox;?>");
window.close();
//-->
</script>
