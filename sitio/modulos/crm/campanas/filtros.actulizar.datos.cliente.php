...
$titulomodulo="Actualizacion de datos de clientes";
?>
<html>
...
?>
							<tr>
								...
								<td style='border:solid 1px #E6E6E6;text-align:center;'>
								<?
								$ruta="../../crm/formularios/registros.editar.php?idx=1&idy=$idcliente&idgaleria=&enca=1" ;
								?>
								<a href='#' onclick=irAPaginaDN('<? echo $ruta; ?>') >Editar</a></td>
