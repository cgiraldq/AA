...
$nombrecampos="Codigo,Preguntas,Posici&oacute;n,Activo";
		 ...
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <td align="center">
			  <select name="idactivo_[]" class="textnegro">
				...
				<option value="3" <? if ($result->fields[3]==3) echo "selected";?>>TEXTO</option>
			  </select>
		  </td>
		  ...
		  if($result->fields[3] <> 3){
	 		  ...
	 		  $rutax="filtros.respuestas.encuesta.php?idpregunta=".$result->fields[0]."&idencuesta=".$_REQUEST['idencuesta']."";
			  $trutax="Click para ingresar respueas";
			  $mrutax="Respuestas";
		  ...
		  |
		  <?
		  $rutax=$pagina."?idxxx=".$result->fields[0]."&idprecio=".$idprecio."&idcampo=".$idcampo."idencuesta=".$_REQUEST['idencuesta'];
		  $formax="";
...
<tr>
	<td align="center" colspan=<? echo $total?>>
		...
		<input type="button" name="enviar" value="Regresar"  class="botones" onclick="irAPaginaD('../../crm/formularios/registros.php?idxx=98&r=1')">
	</td>
</tr>
