...
if ($idx<>"") {
	...
	if ($db->Execute($sql))  {
		...
		$dsruta="../crm/correos/default.php";
...
$sql.=",a.dstelefono,a.dsmovil,a.dsciudad,a.dspais,a.dscorreocliente,a.dscom,a.dsfecha,a.dsdireccion,a.dsempresa,a.dscargo,a.dstipo,a.dsacepto,a.dsid";
