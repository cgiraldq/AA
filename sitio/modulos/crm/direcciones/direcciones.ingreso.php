...
<td>Abreviatura</td>
<td>
<? $contadorx="dsabreviatura_counter";$valorx="255";$formax="u";$campox="dsabreviatura";?>
<input type=text name=dsabreviatura size=60 maxlength="255" class=text1 onKeyPress="ocultar('capa_dsabreviatura')" value="<? echo $dsabreviatura?>" <? include($rutxx."../../incluidos_modulos/control.evento.php");?>>

<?
$nombre_capa="capa_dsabreviatura";
$mensaje_capa="Debe ingresar la abreviatura";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");
?>
</td>
