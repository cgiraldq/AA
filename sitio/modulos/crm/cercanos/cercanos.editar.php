...
$titulomodulo="Configuraci&oacute;n de Puntos cercanos";
$rr="default.php";
$idx=$_REQUEST['idx'];
$tabla="tblcercanos";
$rutaImagen=$rutxx."../../../contenidos/images/cercanos/";
// rutas repro
...
$sql="select a.dsm,a.dsd,a.dsd2,a.dsimg,a.idpos,a.dsruta,a.idactivo,a.dstelefono,a.dsvideo,a.dsvideo2";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
...
$mensaje_capa="Debe ingresar el tel&eacute;fono";
include($rutxx."../../incluidos_modulos/control.capa.php");
include($rutxx."../../incluidos_modulos/control.letras.php");?>
</td>
</tr>
...
&nbsp;<img style="width:30%" src="<? echo $rutaImagen.$dsimg;?>" align="absmiddle" border="0">
<br>
