...
$dscampo=seldato("dsm","id","framecf_tbltiposformulariosxcampo",$idx,2);
if($dscampo=="") $dscampo=seldato("dsm","id"," framecf_tbltiposformulariosxcamposxagrupamiento",$idx,2);

$titulomodulo="Configuraci&oacuten de equivalencias ( $dscampo )";
$tabla="framecf_tbltiposformulariosxequivalenciasxagrupamiento";


$papelera=5;
$pruta="formulario";
include("proceso.equivalencias.php");
?>
<html>
...
$sql.=" from $tabla a where id>0 and idactivo not in(9) and idcampo=$idx and idtipoformulario=$idx2";
