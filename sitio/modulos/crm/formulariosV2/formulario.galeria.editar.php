...
$rr="formulario.galeria.php?idgaleria=$idgaleria&idxx=$idxx&idy=$idy";
...
$sql="select a.dsm,a.dsd,a.dsimg,a.idpos,a.dsruta,a.idactivo,dsimg2";
$sql.=" from $tabla a ";
$sql.=" where a.id=$idx ";
//echo $sql;
...
$rutamodulo.="  <a href='formulario.galeria.php?idy=$idy&idxx=$idxx&idgaleria=$idgaleria' class='textlink'>$titulomodulo</a>  /  <span class='text1'>Modificar</span>";
