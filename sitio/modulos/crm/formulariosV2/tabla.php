...
$nombrecampos="Nombre,Pos,Activo,Publicar en<br> la Web,Desplegable,Estilo del<br> formulario,Formulario<br> tipo cliente,Galeria<br> por Registro";
...
$maxregistros=100;
	...
	if ($dstabla<>"") {
		$sqlx="select count(*) as total from $dstabla where 1 ";
		//echo $sqlx;
