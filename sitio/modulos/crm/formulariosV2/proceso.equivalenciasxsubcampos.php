		...
		$sql="select id ";
		 ...
		 if (!$result->EOF) {
			...
			$mensajes=$men[0];
		 	...
		 	// insertar
			$sql="insert into $tabla (dsm,idpos,idactivo,idcampo,idtipoformulario,idcodigo,idwebservice,idsubcampo)";
			$sql.=" values ('$dsm','$idpos','$idactivo','$idx',$idtipoformulario,'$idcodigo','$idweb','$idx3') ";
