...
?>
	<td>
		<select  name="tipoform" id="tipoform"  onchange="listarcampos('tipoform','dsmcampox','<? echo $_REQUEST['idx2'];?>')">
...
listarcampos('tipoform','dsmcampox','<? echo $_REQUEST["idx2"]?>');

function listarcampos(param,campobase,idform){
	//alert("entra")
	var x=document.getElementById(param).value;
	//alert(x);
	// recargar el combo de clientes
	 rutax="../../validaciones/campos.cargardatos.php?id="+x+"&idx="+idform;
        conexion1=AjaxObj();
