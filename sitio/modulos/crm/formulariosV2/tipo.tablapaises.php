...
$nombrecampos="Id,Titulo,Codigo ISO,Activo";
		...
		?>
		 <tr bgcolor="<? echo $fondo?>" onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" >
		  ...
		  <input type="text" name="dsm_[]" value="<? echo $result->fields[1]?>" size="50" class="textnegro" maxlength="100">
			...
			<td align="center">
		  <input type="text" name="dsvalor_[]" value="<? echo $result->fields[4]?>" size="5" class="textnegro" maxlength="100">
			</td>
		  <!--td align="center">
		  ...
		  <td align="center">
		  		  <?
		  $rutax=$pagina."?idy=".$result->fields[0]."&idx=".$result->fields[3];
		  $formax="";
