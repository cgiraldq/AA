...
$nombrecampos="Id,Nombre,Apellidos,Email,Ciudad,Telefono,C.V,Comentarios";
...
$contar=0;
 ...
 <tr bgcolor="<? echo $fondo?>" <? if ($exportardatos==1) { ?>onMouseOut="mOut(this,'<? echo $fondo;?>');" onMouseOver="mOvr(this,'<? echo $fondo3;?>');" <? } ?>>
		  ...
		  <td align="center">
		  	<? $rutaDocumento="../../../contenidos/images/hojavida/";

		  	if($result->fields[14]<>""){
		  	?>
		  	<a href="<?echo $rut?>..../../descargar.php?path=<? echo $rutaDocumento;?>&file=<? echo $result->fields[14]; ?>">Descargar</a>
		  	<?}?>

		  	</td> <? //servicio de contacto?>
