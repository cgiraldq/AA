...
$titulomodulo="Papelera forma de gestiones";
$titulomodulo2="Configuraci&oacute;n forma de gestiones";
$letra=$_REQUEST['letra'];
$tabla="crmtblgestiones";
$orderby=$_REQUEST['orderby'];
$dsruta="../redes/default.php";//ruta para los logs
...
$sql="select a.id,a.dsnombre,a.idpos,a.idactivo from $tabla a where idactivo=9 ";
