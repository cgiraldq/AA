...
<form action="<? echo $pagina;?>" method=post name=u enctype="multipart/form-data">
  <tr>
    ...
    <table align="center"  cellspacing="1" cellpadding="5" border="0" width=70% class="campos_ingreso campos_ingreso_producto">
            ...
            <tr>
              ...
              <td colspan="2">
              <? $contadorx="dsfecha_counter";$valorx="40";$formax="u";$campox="dsfecha";$maxl="255"?>
              <input type=text name="<? echo $campox?>" size="5" maxlength="10" class=text1 value="<? echo $dsfecha?>" disabled>

              </td>
            </tr>

            <tr>
              <td colspan="3"><p>Acepto Condiciones de Registro</p></td>
              <td colspan="3">
              <? $contadorx="dsacepto_counter";$valorx="40";$formax="u";$campox="dsacepto";$maxl="255"?>
              <input type=text name="<? echo $campox?>" size="5" maxlength="10" class=text1 value="<? echo $dsacepto?>" disabled>
