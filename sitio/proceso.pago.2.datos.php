...
$dsflete=$dsflete+$dsvalorenvio;
          ...
          // echo $sql;
           // exit();
             ...
             $sql.=",aranceltrans,idmanejoadministratrans,idserviciotrans,valoracion,nombreserviciotrans";
           ...
           //exit();
              if ($db->Execute($sql)){
                if ($tipotransc=="1") {
                    ...
                    $mensaje.="Presione '<strong>Ir a principal</strong>' para finalizar el proceso e '<strong>Imprimir El pedido</strong>' para una copia del pedido.";
                } else {
          ...
          if ($idactivopago==1){
            ...
            //$db->debug=true;
             if ($tipotransc=="1") {
                ...
                $sql=" update ecommerce_tblpagos set idestado=0 where idpedido=$idpedido and idclientepago=$idclientepedido";
            }
