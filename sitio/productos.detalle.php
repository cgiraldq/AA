...
if ($idtipo=="") $idtipo=seldato("idtipo","id","tblproductos",$idrelacion,1);
if ($dsnombre=="") $dsnombre=seldato("dsruta","id","tblproductos",$idrelacion,1);
                   // $db->debug=true;
                  ...
                  $sql.=",a.dsunidadesdispo,a.dsunidad,a.dsruta,a.dsreferencia,a.dsd2txt,a.dsdcondicionestxt,a.precio3,a.precio4,a.precio5,a.dsflete,a.dscaractxt,a.dscarac";
                  $sql.=" from tblproductos a where a.id=$idrelacion and ($fechaBaseNum between a.idfechainicial and a.idfechafinal) ";
                  //echo $sql;
                  ...
                  if(!$result->EOF){
                      ...
                      $dscarac=reemplazar($result->fields[41]);
                      ...
                      //*********  Fin Bloque  Valores Segun Tipo Cliente ******************
                       ...
                       //**********************inicio  Valor De La Promocion ***********************// 
                        ...
                        $sqldes="select a.id,a.dsporcentaje,idprecio  from tblpromociones a , ";
                        $sqldes.="tblpromocionesxproducto b where  1 and idactivo not in (2,9) ";
                        ...
                        $sqldes="select a.id,a.dsporcentaje,idprecio  from tblpromociones a , ";
                        $sqldes.="tblpromocionesxcategoria b where  1 and idactivo not in (2,9) ";
                        $sqldes.=" and ".date("YmdHi")." between idfechai and idfechaf ";
                        $sqldes.=" and b.idprecio=$xprecio ";
                        $sqldes.=" and b.idorigen=a.id ";
                        ...
                        $sqldes="select a.id,a.dsporcentaje,idprecio  from tblpromociones a , ";
                        $sqldes.=" tblpromocionesxsubcategoria b where  1 and idactivo not in (2,9) ";
                        $sqldes.=" and ".date("YmdHi")." between idfechai and idfechaf ";
                        $sqldes.=" and b.idprecio=$xprecio ";
                        $sqldes.=" and b.idorigen=a.id ";
...
//-->
                ...
                <?}
                 $result->Close();
                      ...
                      $cat="0";
                      $sql="select a.id from tblcategoria a inner join tblcategoriaxtblproducto b on b.iddestino=a.id ";
                      if ($idtienda >1 ) $sql.=" inner join tblempresaxtblproducto c on c.idorigen=a.id ";
    ...
    <body>
        ...
        <section class="cont_pagina">
            ...
            <section class="cont_header">
              <?include("incluidos_sitio/header/fondo.php");?>
            </section>

          <section class="cont_br">
            <section class="cont_cuerpo_general">
                <?include($rut."incluidos_sitio/header/header.php");?>
              <?include("incluidos_sitio/menu/menu.superior.internas.php");?>
                <section id="cont_principal">
                    ...
                    switch ($idtipo) {
                        case 0:
                            include($rut."incluidos_sitio/productos/productos.detalle.php");
                            break;
                        ...
                        default:
                            //  echo "entra";
                              $incluidotipo=seldato("dsd","id","tbltiposproductos",$idtipo,1);
                              include($rut."incluidos_sitio/productos/".$incluidotipo);

                               break; }
                    ?>

                    <?//include($rut."incluidos_sitio/productos/info.no.encuentras.php");?>
                    <?include($rut."incluidos_sitio/productos/otros.productos.php");?>

                </section>
                <?include($rut."incluidos_sitio/aside/aside.php");?>
                <?include($rut."incluidos_sitio/banners/banner_inferior.php");?>
            </section>
          </section>

            <section class="cont_footer">
                <?//include($rut."incluidos_sitio/menu/menu.inferior.php");?>
