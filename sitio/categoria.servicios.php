        ...
        <section class="cont_pagina">
            ...
            <section class="cont_cuerpo_general">
                <section id="cont_principal">
                    ...
                    <?include("incluidos_sitio/banners/banner.centro.php");?>
                    <?include("incluidos_sitio/servicios/categoria.servicios.vertical.php");?>
                    <?//include("incluidos_sitio/productos/productos.horizontal.php");?>
                </section>
                <?include("incluidos_sitio/aside/aside.php");?>
                <?include("incluidos_sitio/banners/banner_inferior.php");?>
                <?include("incluidos_sitio/carrusel_afiliado/carrusel.afiliado.php");?>
            </section>
