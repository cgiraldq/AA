...
if ($idrelacion=="") $idrelacion=seldato("id","dsruta","ecommerce_tblcategoria",$_REQUEST['dsnombre'],2);
   // $db->debug=true;
    ...
    <section class="cont_pagina">
        ...
        <?include("incluidos_sitio/menu/menu.superior.php");?>
            ...
            <section class="cont_cuerpo_general">
                    ...
                    <?//include("incluidos_sitio/ecommerce/productos/categoria.productos.destacados.php");?>

                    <?include("incluidos_sitio/ecommerce/productos/subcategoria.productos.destacados.php");?>
                    <?//include("incluidos_sitio/ecommerce/productos/subcategoria.productos.vertical.wear.php");?>
