            ...
            <section class="cont_cuerpo_general">
                ...
                <section id="cont_principal">
                    ...
                    <?include("incluidos_sitio/miga/miga.php");?>
                       <?include("incluidos_sitio/index/bannersuperior.php");?>
                       <?include("incluidos_sitio/index/videosuperior.php");?>
                    <?include("incluidos_sitio/oficinas/oficinas.vertical.php");?>
                     <?include("incluidos_sitio/index/videoinferior.php");?>
                     <?include("incluidos_sitio/index/bannerinferior.php");?>
                </section>
