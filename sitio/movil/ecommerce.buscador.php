...
<body>
    ...
    <section class="cont_pagina">
        ...
        <section class="cont_cuerpo_general">
            <?//include("incluidos_sitio/ecommerce/carrito/carrito.barra.php");?>
            <?//include("incluidos_sitio/index/botones.index.php");?>
            <?//include("incluidos_sitio/index/botones.img.php");?>
            <?include("incluidos_sitio/index/banner.superior.php");?>
            <?include("incluidos_sitio/index/video.superior.php");?>
                        <?include("incluidos_sitio/buscador/ecommerce.resultados.busqueda.php");?>
            <?//include("incluidos_sitio/index/index.php");?>
            <?//include("incluidos_sitio/index/q.somos.php");?>
