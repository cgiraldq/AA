<?
   $sql="select a.id,a.dsm,a.dsruta,a.dsimg,a.dsmodo from tblvistabanners a, tblvistaxtblbanners b where a.idactivo='3' and a.id=b.idorigen and b.iddestino='$idpagina' ";
