...
<fieldset class="contenedor_capcha">
   <div class="img_capcha or"><img src="captcha/captcha.php" id="captcha" alt=""></div>
   <div class="or or_cont">
       ...
       <p class="txt_blanco1" style="cursor:pointer" onclick="document.getElementById('captcha').src='captcha/captcha.php?'+Math.random();" id="change-image">Cambiar Captcha</p>
   </div>
