<article class="cont_noticas_centro_vertical">
	...
	$sql="select dstit,dsd,dskw,dsd2,id,idactivo,dstitulo,dsvideo from tblisuu where (dsm='$pag' or dsmalterna='$pag') and idtienda=$idtienda ";
...
?>
	...
	<?
	$sql="select a.id,a.dsm,a.dsd,a.dsvideo from isuu a where a.idactivo=1 order by idpos asc ";
