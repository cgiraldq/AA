...
if ($idtienda>1) $rutaFuenteImagenes="http://localhost:8082/"; // ruta de origen de datos siempre y cuando sea tienda no primaria
...
$correoautorizado="info@comprandofacil.com";
$rutaComprasYpagos="http://$autorizado/sitio/";

$nombreautorizado=" Adriana arango ".date("Y");
$rutaComprasYpagos="http://$autorizado/sitio/";
// ruta de sindicacion
