...
session_start();
ob_start();
include('../incluidos_modulos/varconexion.variables.php');
...
$sql6="select id,fecharegistro from tblcandidatos where idasociado=".$_SESSION['i_id'];
...
define('FPDF_FONTPATH','incluidos/fuentesPDF/');
require('incluidos/fpdf.php');
...
$nombre_archivo=$_SESSION['i_nombre1']."_".$_SESSION['i_nombre2']."_".$_SESSION['i_apellido1']."_".$_SESSION['i_apellido2'].".pdf";
//$pdf->Output("$nombre_archivo",'F');

}
$nombre=$_SESSION['i_nombre1'];
