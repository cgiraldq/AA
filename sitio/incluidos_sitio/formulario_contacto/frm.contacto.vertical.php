...
?>
	...
	<form action="modulos/validaciones/contacto.php" name="frm_contacto" method="post" id="frm_contacto">
		...
		<nav class="btn_derecha">
			<input type="button" value="Enviar" class="btn_trayectoria" onclick="valFormulario('<?echo $forma?>','<? echo $param?>',0,'','<? echo $rutalocal."/"; ?>');">
			<input type="reset" value="Cancelar" class="btn_trayectoria">
		</nav>
	</form>
</article>
