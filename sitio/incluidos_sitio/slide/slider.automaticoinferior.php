...
$sql="select a.id,a.dsm,a.dsruta,a.dsimg from tblbanners a, tblbannersxtblpaginas b where a.idactivo=5 and a.id=b.idorigen and b.iddestino='$idpagina'  order by a.idpos asc LIMIT 0,1";
                //echo $sql;
                $result=$db->Execute($sql);
                if(!$result->EOF){
?>
