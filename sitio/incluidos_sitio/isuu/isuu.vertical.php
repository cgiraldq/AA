...
?>
	...
	<?//include("incluidos_sitio/isuu/isuu.destacado.php");?>


	<?
	$sql="select a.id,a.dsm,a.dsd,a.dsvideo,a.dsimg from tblisuu a where a.idactivo=1 order by idpos asc ";
			...
			$dsimg=$resultx->fields[dsimg];

?>



	<article class="cont_isuu">
		...
		<br style="clear:both;">
		<?if(is_file("../contenidos/images/videos/".$dsimg)){?>
			
			<a href="descargar.php?file=<?echo $dsimg?>&path=../contenidos/images/videos/"><article class="btn_general" >Descargar</article></a>
