<article class="bloque_formularios" id="frm_<? echo $contador;?>" <? if($iddesplegable==1){?>style="display:none"<?}?> >
		<article class="txt_lateral">
			<? if($pagina<>"consignar_clasificado.php"){?>
			<h2><?echo reemplazar($dsmx);?></h2>
			<?}?>
		</article>
	...
	<article class="cont_frm_lateral">
...
if ($idoblig==1) $param.=$dsmcampo.",";
	...
	?>
	<fieldset>
			<div><input type="text" name="<? echo $dsmcampo;?>" id="<? echo $dsmcampo;?>" placeholder="<? echo reemplazar($dsm); if ($idoblig==1){ echo "*";}?>"  onkeypress="valFormulario('<?echo $forma?>','<? echo $param?>',1,'capax_<? echo $dsmcampo;?>','')"></div>
	...
	<fieldset class="textarea">
			...
			<div><textarea style="height: 80px;" cols="46" name="<? echo $dsmcampo;?>" id="<? echo $dsmcampo;?>" placeholder="<? echo reemplazar($dsm); if ($idoblig==1){ echo "*";}?>"  onkeypress="valFormulario('<?echo $forma?>','<? echo $param?>',1,'capax_<? echo $dsmcampo;?>','')"></textarea></div>
			<span class="camp_requerido" id="capax_<? echo $dsmcampo;?>" style="display:none;"><? echo $dsmensaje;?></span>
	</fieldset>
	<?
	}// fin campo textarea
	...
	<fieldset>
			...
			<div><input type="password" name="<? echo $dsmcampo;?>" id="<? echo $dsmcampo;?>" tabindex="1" placeholder="<? echo reemplazar($dsm); if ($idoblig==1){ echo "*";}?>" onkeypress="valFormulario('<?echo $forma?>','<? echo $param?>',1,'capax_<? echo $dsmcampo;?>','')"></div>
			<span class="camp_requerido" id="capax_<? echo $dsmcampo;?>" style="display:none;"><? echo $dsmensaje;?></span>
	</fieldset>
	<?
       ...
       <fieldset>
			...
			<div>
				<select name="<? echo $dsmcampo;?>" id="<? echo $dsmcampo;?>"
					...
					<option value=""><? echo reemplazar($dsm); if ($idoblig==1){ echo "*";}?></option>
       <?
...
<fieldset class="cont_politicas">
	<input type="checkbox">
<a href="<? echo $rutalocal;?>/info.frm.php" class="ver_mas group1" rel="group1"><p>POLÍTICA DE PROTECCIÓN DE DATOS</p></a>
</fieldset>
...
<fieldset class="btns">
	...
	<?$correo=seldato2("dscampo","idtipo","framecf_tbltiposformulariosxcampo",5,"idtipoformulario",$idformulario,2);?>
			...
			<input type="button" value="Enviar" class="btn_enviar_lateral" onclick="valFormulario('<?echo $forma;?>','<? echo $param;?>,captcha',0,'','<? echo $rutalocal."/"; ?>','<? echo $correo;?>');">
</fieldset>
</form>
