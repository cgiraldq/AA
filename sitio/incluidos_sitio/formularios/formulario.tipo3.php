...
$sqlx="select a.id,a.dsm,a.dsmensaje,a.idtipo,a.idoblig,a.idposn,a.dscampo,a.idminimo,a.idtipoformulario,a.idactivo,a.dsdes,a.dsmensaje,a.idpublicar ";
...
if ($idoblig==1 and $idpublicar==1) $param.=$dsmcampo.",";
...
?>
		...
		<? if($iframemap=="") include("incluidos_sitio/formularios/remate.form.php");?>
<?
