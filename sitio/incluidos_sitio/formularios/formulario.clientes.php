...
<fieldset class="cont_politicas">
	<input type="checkbox">
<a href="<? echo $rutalocal;?>/info.frm.php" class="ver_mas iframe2"><p>POLÍTICA DE PROTECCIÓN DE DATOS</p></a>
</fieldset>
...
<fieldset class="btns">
	...
	<?$correo=seldato2("dscampo","idtipo","framecf_tbltiposformulariosxcampo",5,"idtipoformulario",$idformulario,2);?>
			...
			onclick="valFormulario('<?echo $forma;?>','<? echo $param;?>,captcha',0,'','<? echo $rutalocal."/"; ?>','<? echo $correo;?>');">
</fieldset>
</form>
