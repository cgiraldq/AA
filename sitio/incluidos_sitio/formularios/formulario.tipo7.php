<article class="bloque_formularios" id="frm_<? echo $contador;?>" <? if($iddesplegable==1){?>style="display:none"<?}?> >
		...
		<h2>ÍNSCRIBETE A NUESTRO BOLETÍN</h2>
		<?
...
<input type="button" value="Enviar" class="btn_general" onclick="valFormulario('<?echo $forma;?>','<? echo $param;?>',0,'<? echo $correo;?>','<? echo $rutalocal."/"; ?>','<? echo $id;	?>');">
</fieldset>
