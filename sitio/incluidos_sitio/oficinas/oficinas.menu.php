	...
	?>
      <ul>
      	...
      	/*while(!$result->EOF) {
			...
			$dsrutax=$rutalocal."/asociados/".$dsruta;
		...
		*/
        ...
        <!--li>
        	<a href="<? echo $dsrutax; ?>" class="btn_general">
        		<p <?//if($id==$idm){echo "style='color:#2B5F28;background: #F3F9CF' "; }?>>
        			<? //echo $dstitulo;?></p>
        	</a>
        </li-->

        <li>
        	<a href="<? //echo $dsrutax; ?>oficinas.php" class="btn_general">
        		<p>AGENCIAS</p>
        	</a>
        </li>

         <li>
        	<a href="<? //echo $dsrutax; ?>puntos.recaudo.php" class="btn_general">
