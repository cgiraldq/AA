 ...
 <br><a name="anclaform"></a>
  ...
  <nav class="cont_botenes">
    <ul class="tabs">
      ...
      <li><a href="#anclaform" onclick="abrir_forma('frm_solicitar_pro_1','frm_solicitar_pro_2');"  class="btn_solicitar"><h2>Solicitar Servicio</h2></a></li>
       <li>
        <a href="http://sucursal.coogranada.com.co/Simuladores/Credito.aspx" target="_blank" class="btn_simulador"><h2>Ver Agencias</h2>
        </a>
...
<?
  include("incluidos_sitio/productos/formulario.solicitar.producto.php");
...
<?  include("incluidos_sitio/productos/otros.productos.php");?>
