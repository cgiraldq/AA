...
// echo "1.".$idrelacion."</br>";
$idrelacionx=$_REQUEST['dscategoria'];
// echo "2.".$idrelacionx."</br>";
if($idrelacionx=="")$idrelacionx=seldato("id","dsruta","ecommerce_tblcategoria",$_REQUEST['dscategoriax'],2);
...
$sql.=" and a.id=b.idorigen order by a.idpos asc, id desc ";
// echo $sql;
...
<article class="ecommerce_subcategorias">
		...
		$dsrutax="../".$_REQUEST['dscategoriax']."/".$dsruta;	
		}
