  ...
  <article class="bloques_productos">
    <ul class="categorias_productos">
       <? while(!$result->EOF){
          ...
          if(!$resultx->EOF){
            ...
            if($total<1) $ruta="mis_productos";
             ...
             if($total>0) $rutax="cms.productos.subcategorias.php";
            if($total<1) $rutax="cms.productos.php";
      ...
      <a href="<? echo $dsrutax;?>"><p><? echo ellistr($dsd,150);?></p></a>
